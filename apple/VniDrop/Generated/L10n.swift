// Generated by localization/ (bun run src/cli.ts generate). Do not edit.
...
enum L10n {
    enum About {
        ...
        /// - it: Segnala un bug
        /// - de: Fehler melden
        /// - pt: Comunicar um erro
        /// - pl: Zgłoś błąd
        /// - nl: Een fout melden
        /// - ru: Сообщить об ошибке
        static let bugReport: String.LocalizationValue = "about_bug_report"
        /// VniDrop moves files and folders straight from one device to another over the network, without uploading them to any file-hosting service. There’s no account to create, and no copy of your transfer is left in the cloud once you’re done.
        ///
        ...
        /// - pt: O VniDrop transfere ficheiros e pastas diretamente de um dispositivo para outro através da rede, sem os carregar para qualquer serviço de alojamento. Não é necessário criar qualquer conta e não fica nenhuma cópia da sua transferência na nuvem depois de terminar.
        /// - pl: VniDrop przesyła pliki i foldery bezpośrednio z jednego urządzenia na drugie przez sieć, bez przesyłania ich do jakiejkolwiek usługi hostingowej. Nie trzeba zakładać konta, a po zakończeniu żadna kopia transferu nie pozostaje w chmurze.
        /// - nl: VniDrop verplaatst bestanden en mappen rechtstreeks van het ene apparaat naar het andere via het netwerk, zonder ze naar een hostingdienst te uploaden. U hoeft geen account aan te maken en er blijft geen kopie van uw overdracht in de cloud achter zodra u klaar bent.
        /// - ru: VniDrop передаёт файлы и папки напрямую с одного устройства на другое по сети, не загружая их в какой-либо хостинг-сервис. Не нужно создавать учётную запись, и после завершения ни одна копия вашей передачи не остаётся в облаке.
        static let description: String.LocalizationValue = "about_description"
        ...
        /// - pt: Uma transferência direta entre dispositivos — os seus ficheiros vão diretamente para o destinatário.
        /// - pl: Bezpośredni transfer między urządzeniami — pliki trafiają prosto do odbiorcy.
        /// - nl: Een directe overdracht van apparaat naar apparaat — uw bestanden gaan rechtstreeks naar de ontvanger.
        /// - ru: Прямая передача с устройства на устройство — ваши файлы попадают напрямую к получателю.
        static let isDirect: String.LocalizationValue = "about_is_direct"
        /// Connections are authenticated and end-to-end encrypted (via Iroh), and incoming files are verified by their content hash.
        ///
        /// Key: `about_is_encrypted`
        ...
        /// - pt: As ligações são autenticadas e cifradas ponto a ponto (através do Iroh), e os ficheiros recebidos são verificados pela impressão digital do seu conteúdo.
        /// - pl: Połączenia są uwierzytelniane i szyfrowane od końca do końca (przez Iroh), a przychodzące pliki są weryfikowane na podstawie skrótu ich zawartości.
        /// - nl: Verbindingen zijn geverifieerd en end-to-end versleuteld (via Iroh), en binnenkomende bestanden worden gecontroleerd aan de hand van hun inhouds-hash.
        /// - ru: Соединения аутентифицированы и зашифрованы сквозным шифрованием (через Iroh), а входящие файлы проверяются по хешу их содержимого.
        static let isEncrypted: String.LocalizationValue = "about_is_encrypted"
        /// You decide who receives: approve each request, or open a transfer to anyone holding the invitation.
        ///
        /// Key: `about_is_in_control`
        ...
        /// - pt: É você quem decide quem recebe: aprove cada pedido ou abra uma transferência a qualquer pessoa que tenha o convite.
        /// - pl: To Ty decydujesz, kto otrzymuje: zatwierdź każde żądanie lub udostępnij transfer każdemu, kto ma zaproszenie.
        /// - nl: U bepaalt wie ontvangt: keur elk verzoek goed, of stel een overdracht open voor iedereen met de uitnodiging.
        /// - ru: Вы решаете, кто получает: одобряйте каждый запрос или откройте передачу всем, у кого есть приглашение.
        static let isInControl: String.LocalizationValue = "about_is_in_control"
        /// Account-free — there’s nothing to sign up for.
        ///
        /// Key: `about_is_no_account`
        ...
        /// - pt: Sem conta — não há nada para registar.
        /// - pl: Bez konta — nie trzeba się rejestrować.
        /// - nl: Zonder account — er is niets om aan te melden.
        /// - ru: Без учётной записи — регистрироваться не нужно.
        static let isNoAccount: String.LocalizationValue = "about_is_no_account"
        ...
        /// - pt: Código aberto, publicado sob a licença Apache 2.0.
        /// - pl: Otwarte oprogramowanie, wydane na licencji Apache 2.0.
        /// - nl: Opensource, uitgebracht onder de Apache 2.0-licentie.
        /// - ru: Открытый исходный код, распространяется по лицензии Apache 2.0.
        static let isOpen: String.LocalizationValue = "about_is_open"
        /// What VniDrop is
        ///
        /// Key: `about_is_title`
        ...
        /// - it: Cos’è VniDrop
        /// - de: Was VniDrop ist
        /// - pt: O que o VniDrop é
        /// - pl: Czym jest VniDrop
        /// - nl: Wat VniDrop is
        /// - ru: Что такое VniDrop
        static let isTitle: String.LocalizationValue = "about_is_title"
        /// Not cloud storage — no server holds your files, and nothing waits in the cloud after a transfer.
        ///
        /// Key: `about_isnt_cloud`
        ...
        /// - pt: Não é armazenamento na nuvem — nenhum servidor guarda os seus ficheiros e nada fica na nuvem após uma transferência.
        /// - pl: To nie magazyn w chmurze — żaden serwer nie przechowuje Twoich plików i nic nie pozostaje w chmurze po transferze.
        /// - nl: Geen cloudopslag — geen enkele server bewaart uw bestanden en er wacht niets in de cloud na een overdracht.
        /// - ru: Это не облачное хранилище — ни один сервер не хранит ваши файлы, и после передачи в облаке ничего не остаётся.
        static let isntCloud: String.LocalizationValue = "about_isnt_cloud"
        /// Not public broadcasting — an invitation is a private access link, not an announcement to everyone nearby.
        ///
        /// Key: `about_isnt_public`
        ...
        /// - pt: Não é difusão pública — um convite é uma ligação de acesso privado, não um anúncio a toda a gente por perto.
        /// - pl: To nie publiczne rozgłaszanie — zaproszenie to prywatny link dostępu, a nie ogłoszenie dla wszystkich w pobliżu.
        /// - nl: Geen openbare uitzending — een uitnodiging is een privétoegangslink, geen aankondiging aan iedereen in de buurt.
        /// - ru: Это не публичная рассылка — приглашение является частной ссылкой доступа, а не объявлением для всех поблизости.
        static let isntPublic: String.LocalizationValue = "about_isnt_public"
        /// Not a sync or backup service.
        ///
        /// Key: `about_isnt_sync`
        ...
        /// - pt: Não é um serviço de sincronização ou de cópia de segurança.
        /// - pl: To nie usługa synchronizacji ani kopii zapasowej.
        /// - nl: Geen synchronisatie- of back-updienst.
        /// - ru: Это не служба синхронизации или резервного копирования.
        static let isntSync: String.LocalizationValue = "about_isnt_sync"
        /// What VniDrop isn’t
        ///
        /// Key: `about_isnt_title`
        ...
        /// - pt: O que o VniDrop não é
        /// - pl: Czym VniDrop nie jest
        /// - nl: Wat VniDrop niet is
        /// - ru: Чем VniDrop не является
        static let isntTitle: String.LocalizationValue = "about_isnt_title"
        /// License
        ///
        /// Key: `about_license_label`
        ...
        /// - nl: Licentie
        /// - ru: Лицензия
        static let licenseLabel: String.LocalizationValue = "about_license_label"
        /// Privacy policy
        ///
        /// Key: `about_privacy`
        ...
        static let privacy: String.LocalizationValue = "about_privacy"
        /// Invitations are capabilities. Treat a QR code, NFC tag, or .vnd file like a private access link and share it only with the people you intend — especially with “Anyone with this transfer.”
        ///
        /// Key: `about_privacy_capability`
        ...
        /// - pt: Os convites são chaves de acesso. Trate um código QR, uma etiqueta NFC ou um ficheiro .vnd como uma ligação de acesso privado e partilhe-o apenas com as pessoas pretendidas — sobretudo com «Qualquer pessoa com esta transferência».
        /// - pl: Zaproszenia są kluczami dostępu. Traktuj kod QR, tag NFC lub plik .vnd jak prywatny link dostępu i udostępniaj go tylko zamierzonym osobom — zwłaszcza przy opcji „Każdy, kto ma ten transfer”.
        /// - nl: Uitnodigingen zijn toegangssleutels. Behandel een QR-code, NFC-tag of .vnd-bestand als een privétoegangslink en deel deze alleen met de bedoelde personen — vooral bij ‘Iedereen met deze overdracht’.
        /// - ru: Приглашения — это ключи доступа. Относитесь к QR-коду, NFC-метке или файлу .vnd как к частной ссылке доступа и делитесь ими только с теми, для кого они предназначены, особенно при варианте «Любой, у кого есть эта передача».
        static let privacyCapability: String.LocalizationValue = "about_privacy_capability"
        /// Deny by default — VniDrop serves only the content of an active share and rejects unknown requests.
        ///
        /// Key: `about_privacy_deny`
        ...
        /// - pt: Recusa por predefinição — o VniDrop apenas fornece o conteúdo de uma partilha ativa e rejeita pedidos desconhecidos.
        /// - pl: Domyślnie odmowa — VniDrop udostępnia tylko zawartość aktywnego udostępnienia i odrzuca nieznane żądania.
        /// - nl: Standaard weigeren — VniDrop levert alleen de inhoud van een actieve deling en wijst onbekende verzoeken af.
        /// - ru: Отказ по умолчанию — VniDrop предоставляет только содержимое активной передачи и отклоняет неизвестные запросы.
        static let privacyDeny: String.LocalizationValue = "about_privacy_deny"
        /// Received files are saved on your device and never silently overwrite an existing file.
        ///
        /// Key: `about_privacy_local`
        ...
        /// - pt: Os ficheiros recebidos são guardados no seu dispositivo e nunca substituem um ficheiro existente.
        /// - pl: Odebrane pliki są zapisywane na Twoim urządzeniu i nigdy nie nadpisują istniejącego pliku.
        /// - nl: Ontvangen bestanden worden op uw apparaat bewaard en overschrijven nooit een bestaand bestand.
        /// - ru: Полученные файлы сохраняются на вашем устройстве и никогда не перезаписывают существующий файл.
        static let privacyLocal: String.LocalizationValue = "about_privacy_local"
        /// Privacy policy
        ///
        /// Key: `about_privacy_policy_label`
        ...
        /// If two devices can’t connect directly, the encrypted connection may be relayed. Relays forward encrypted packets only; they never store your files.
        ///
        /// Key: `about_privacy_relay`
        ...
        /// - pt: Se dois dispositivos não conseguirem ligar-se diretamente, a ligação cifrada pode ser retransmitida. Os retransmissores apenas encaminham pacotes cifrados; nunca guardam os seus ficheiros.
        /// - pl: Jeśli dwa urządzenia nie mogą połączyć się bezpośrednio, szyfrowane połączenie może być przekazywane przez przekaźnik. Przekaźniki przekazują tylko zaszyfrowane pakiety; nigdy nie przechowują Twoich plików.
        /// - nl: Als twee apparaten niet rechtstreeks verbinding kunnen maken, kan de versleutelde verbinding via een relay worden doorgestuurd. Relays sturen alleen versleutelde pakketten door; ze slaan uw bestanden nooit op.
        /// - ru: Если два устройства не могут соединиться напрямую, зашифрованное соединение может передаваться через ретранслятор. Ретрансляторы пересылают только зашифрованные пакеты; они никогда не хранят ваши файлы.
        static let privacyRelay: String.LocalizationValue = "about_privacy_relay"
        /// Privacy & security
        ///
        /// Key: `about_privacy_title`
        ...
        static let privacyTitle: String.LocalizationValue = "about_privacy_title"
        ...
        /// - pt: Envie ficheiros diretamente. Mantenha o controlo sobre quem os recebe.
        /// - pl: Wysyłaj pliki bezpośrednio. Zachowaj kontrolę nad tym, kto je otrzymuje.
        /// - nl: Verstuur bestanden rechtstreeks. Houd controle over wie ze ontvangt.
        /// - ru: Отправляйте файлы напрямую. Сохраняйте контроль над тем, кто их получает.
        static let tagline: String.LocalizationValue = "about_tagline"
        /// About
        ///
        /// Key: `about_title`
        ...
        /// - nl: Over
        /// - ru: О приложении
        static let title: String.LocalizationValue = "about_title"
    }
    enum Appearance {
        /// Match this device’s light or dark appearance.
        ///
        /// Key: `appearance_auto_description`
        ...
        /// - pt: Acompanhar o aspeto claro ou escuro deste dispositivo.
        /// - pl: Dopasuj do jasnego lub ciemnego wyglądu tego urządzenia.
        /// - nl: De lichte of donkere weergave van dit apparaat volgen.
        /// - ru: Следовать светлому или тёмному оформлению этого устройства.
        static let autoDescription: String.LocalizationValue = "appearance_auto_description"
        /// Dark mode
        ///
        ...
        /// - nl: Donkere modus
        /// - ru: Тёмный режим
        static let darkMode: String.LocalizationValue = "appearance_dark_mode"
        /// Light mode
        ///
        /// Key: `appearance_light_mode`
        ...
        /// - nl: Lichte modus
        /// - ru: Светлый режим
        static let lightMode: String.LocalizationValue = "appearance_light_mode"
        /// System
        ///
        /// Key: `appearance_system_mode`
        ...
        /// - nl: Systeem
        /// - ru: Системный
        static let systemMode: String.LocalizationValue = "appearance_system_mode"
        /// Appearance
        ///
        /// Key: `appearance_title`
        ...
        /// - nl: Weergave
        /// - ru: Оформление
        static let title: String.LocalizationValue = "appearance_title"
    }
    enum Approval {
        /// Receive request
        ///
        /// Key: `approval_connection_request`
        ...
        /// - pl: Prośba o odbiór
        /// - nl: Ontvangstverzoek
        /// - ru: Запрос на получение
        static let connectionRequest: String.LocalizationValue = "approval_connection_request"
        /// Device ID: {deviceId}
        ///
        /// Key: `approval_endpoint_id`
        ...
        static func endpointId(deviceId: String) -> String {
            String(format: String(localized: "approval_endpoint_id"), deviceId)
        }
        /// A nearby device
        ///
        /// Key: `approval_nearby_device`
        ...
        /// - pt: Um dispositivo próximo
        /// - pl: Urządzenie w pobliżu
        /// - nl: Een apparaat in de buurt
        /// - ru: Устройство поблизости
        static let nearbyDevice: String.LocalizationValue = "approval_nearby_device"
        ...
        /// - pt: {count} pedidos em espera
        /// - pl: Oczekujące prośby: {count}
        /// - nl: {count} verzoeken in behandeling
        /// - ru: Ожидающих запросов: {count}
        static func pendingCount(count: Int) -> String {
            String(format: String(localized: "approval_pending_count"), count)
        }
        /// {receiver} wants to receive “{transferName}”.
        ///
        /// Key: `approval_request_body`
        ...
        static func requestBody(receiver: String, transferName: String) -> String {
            String(format: String(localized: "approval_request_body"), receiver, transferName)
        }
    }
    enum Battery {
        /// Battery level
        ///
        /// Key: `battery_level_title`
    ...
    enum Bug {
        ...
        /// - pt: nome@exemplo.com
        /// - pl: nazwa@przyklad.com
        /// - nl: naam@voorbeeld.com
        /// - ru: имя@пример.com
        static let reportContactHint: String.LocalizationValue = "bug_report_contact_hint"
        /// Contact email (optional)
        ///
        /// Key: `bug_report_contact_label`
        ...
        /// - pl: E-mail kontaktowy (opcjonalnie)
        /// - nl: Contact-e-mail (optioneel)
        /// - ru: Контактный e-mail (необязательно)
        static let reportContactLabel: String.LocalizationValue = "bug_report_contact_label"
        ...
        /// - pt: Diga-nos o que correu mal. Anexamos informações do dispositivo e, opcionalmente, registos recentes (com os valores sensíveis ocultados).
        /// - pl: Napisz, co poszło nie tak. Dołączamy informacje o urządzeniu i opcjonalnie ostatnie dzienniki (z ukrytymi wrażliwymi wartościami).
        /// - nl: Vertel ons wat er misging. We voegen apparaatgegevens toe en optioneel recente logbestanden (met gevoelige waarden onleesbaar gemaakt).
        /// - ru: Расскажите, что пошло не так. Мы прикладываем сведения об устройстве и, при желании, недавние журналы (конфиденциальные значения скрыты).
        static let reportDescription: String.LocalizationValue = "bug_report_description"
        /// Device information
        ///
        /// Key: `bug_report_device_section`
        ...
        static let reportDeviceSection: String.LocalizationValue = "bug_report_device_section"
        /// Describe what you expected to happen
        ///
        /// Key: `bug_report_expected_hint`
        ...
        /// - pt: Descreva o que esperava que acontecesse
        /// - pl: Opisz oczekiwane zachowanie
        /// - nl: Beschrijf wat u verwachtte
        /// - ru: Опишите, что вы ожидали
        static let reportExpectedHint: String.LocalizationValue = "bug_report_expected_hint"
        /// What did you expect?
        ///
        /// Key: `bug_report_expected_label`
        ...
        /// - nl: Wat verwachtte u?
        /// - ru: Что вы ожидали?
        static let reportExpectedLabel: String.LocalizationValue = "bug_report_expected_label"
        /// Include recent logs
        ///
        /// Key: `bug_report_include_logs`
        ...
        /// - pt: Incluir registos recentes
        /// - pl: Dołącz ostatnie dzienniki
        /// - nl: Recente logbestanden meesturen
        /// - ru: Включить недавние журналы
        static let reportIncludeLogs: String.LocalizationValue = "bug_report_include_logs"
        /// Helps us diagnose the issue. Sensitive values are redacted before sending.
        ///
        /// Key: `bug_report_include_logs_description`
        ...
        /// - pt: Ajuda-nos a diagnosticar o problema. Os valores sensíveis são ocultados antes do envio.
        /// - pl: Pomaga nam zdiagnozować problem. Wrażliwe wartości są ukrywane przed wysłaniem.
        /// - nl: Helpt ons het probleem te diagnosticeren. Gevoelige waarden worden vóór verzending onleesbaar gemaakt.
        /// - ru: Помогает нам диагностировать проблему. Конфиденциальные значения скрываются перед отправкой.
        static let reportIncludeLogsDescription: String.LocalizationValue = "bug_report_include_logs_description"
        /// Log attachment size
        ///
        /// Key: `bug_report_logs_size`
        ...
        /// - pt: Tamanho do anexo de registos
        /// - pl: Rozmiar załącznika z dziennikami
        /// - nl: Grootte van logbijlage
        /// - ru: Размер вложения с журналами
        static let reportLogsSize: String.LocalizationValue = "bug_report_logs_size"
        /// Please describe what you expected.
        ///
        /// Key: `bug_report_missing_expected`
        ...
        /// - pt: Descreva o que esperava.
        /// - pl: Opisz oczekiwane zachowanie.
        /// - nl: Beschrijf wat u verwachtte.
        /// - ru: Опишите, что вы ожидали.
        static let reportMissingExpected: String.LocalizationValue = "bug_report_missing_expected"
        /// Please describe what happened.
        ///
        /// Key: `bug_report_missing_what`
        ...
        /// - pl: Opisz, co się stało.
        /// - nl: Beschrijf wat er gebeurde.
        /// - ru: Опишите, что произошло.
        static let reportMissingWhat: String.LocalizationValue = "bug_report_missing_what"
        /// List the steps to reproduce the issue
        ///
        /// Key: `bug_report_steps_hint`
        ...
        /// - pt: Enumere os passos para reproduzir o problema
        /// - pl: Wymień kroki umożliwiające odtworzenie problemu
        /// - nl: Noem de stappen om het probleem te reproduceren
        /// - ru: Перечислите шаги для воспроизведения проблемы
        static let reportStepsHint: String.LocalizationValue = "bug_report_steps_hint"
        /// Steps to reproduce (optional)
        ///
        /// Key: `bug_report_steps_label`
        ...
        /// - pl: Kroki do odtworzenia (opcjonalnie)
        /// - nl: Stappen om te reproduceren (optioneel)
        /// - ru: Шаги для воспроизведения (необязательно)
        static let reportStepsLabel: String.LocalizationValue = "bug_report_steps_label"
        /// Submit report
        ///
        /// Key: `bug_report_submit`
        ...
        /// - nl: Rapport versturen
        /// - ru: Отправить отчёт
        static let reportSubmit: String.LocalizationValue = "bug_report_submit"
        /// Could not submit the bug report. Try again later.
        ///
        /// Key: `bug_report_submit_failed`
        ...
        /// - pt: Não foi possível enviar o relatório de erro. Tente novamente mais tarde.
        /// - pl: Nie udało się wysłać zgłoszenia błędu. Spróbuj ponownie później.
        /// - nl: Het foutrapport kon niet worden verstuurd. Probeer het later opnieuw.
        /// - ru: Не удалось отправить отчёт об ошибке. Повторите попытку позже.
        static let reportSubmitFailed: String.LocalizationValue = "bug_report_submit_failed"
        ...
        /// - pt: Obrigado — o seu relatório de erro foi registado.
        /// - pl: Dziękujemy — Twoje zgłoszenie błędu zostało zapisane.
        /// - nl: Bedankt — uw foutrapport is vastgelegd.
        /// - ru: Спасибо — ваш отчёт об ошибке записан.
        static let reportSubmitted: String.LocalizationValue = "bug_report_submitted"
        /// Submitting…
        ///
        /// Key: `bug_report_submitting`
        ...
        /// - ru: Отправка…
        static let reportSubmitting: String.LocalizationValue = "bug_report_submitting"
        /// Describe what happened
        ///
        /// Key: `bug_report_what_hint`
        ...
        /// - nl: Beschrijf wat er gebeurde
        /// - ru: Опишите, что произошло
        static let reportWhatHint: String.LocalizationValue = "bug_report_what_hint"
        /// What happened?
        ///
        /// Key: `bug_report_what_label`
        ...
        /// - ru: Что произошло?
        static let reportWhatLabel: String.LocalizationValue = "bug_report_what_label"
    }
    enum Button {
        /// Approve
        ///
        ...
        /// - nl: Goedkeuren
        /// - ru: Одобрить
        static let approve: String.LocalizationValue = "button_approve"
        /// Back
        ///
        /// Key: `button_back`
        ...
        /// - nl: Terug
        /// - ru: Назад
        static let back: String.LocalizationValue = "button_back"
        /// Cancel
        ///
        /// Key: `button_cancel`
        ...
        /// - nl: Annuleren
        /// - ru: Отмена
        static let cancel: String.LocalizationValue = "button_cancel"
        /// Cancel
        ///
        /// Key: `button_cancel_receive`
        ...
        /// - nl: Annuleren
        /// - ru: Отмена
        static let cancelReceive: String.LocalizationValue = "button_cancel_receive"
        /// Change files
        ///
        /// Key: `button_change_files`
        ...
        /// - it: Cambia file
        /// - de: Dateien ändern
        /// - pt: Alterar ficheiros
        /// - pl: Zmień pliki
        /// - nl: Bestanden wijzigen
        /// - ru: Изменить файлы
        static let changeFiles: String.LocalizationValue = "button_change_files"
        /// Choose files
        ///
        /// Key: `button_choose_files`
        ...
        /// - nl: Bestanden kiezen
        /// - ru: Выбрать файлы
        static let chooseFiles: String.LocalizationValue = "button_choose_files"
        /// Choose folder
        ///
        /// Key: `button_choose_folder`
        ...
        /// - nl: Map kiezen
        /// - ru: Выбрать папку
        static let chooseFolder: String.LocalizationValue = "button_choose_folder"
        /// Clear
        ///
        /// Key: `button_clear`
        ...
        /// - nl: Wissen
        /// - ru: Очистить
        static let clear: String.LocalizationValue = "button_clear"
        /// Close
        ///
        /// Key: `button_close`
        ...
        /// - nl: Sluiten
        /// - ru: Закрыть
        static let close: String.LocalizationValue = "button_close"
        /// New transfer
        ///
        /// Key: `button_create_new_transfer`
        ...
        /// - pl: Nowy transfer
        /// - nl: Nieuwe overdracht
        /// - ru: Новая передача
        static let createNewTransfer: String.LocalizationValue = "button_create_new_transfer"
        /// Delete transfer
        ///
        /// Key: `button_delete_transfer`
        ...
        /// - pt: Eliminar transferência
        /// - pl: Usuń transfer
        /// - nl: Overdracht verwijderen
        /// - ru: Удалить передачу
        static let deleteTransfer: String.LocalizationValue = "button_delete_transfer"
        /// Save .vnd file
        ///
        /// Key: `button_download_invitation`
        ...
        /// - pt: Guardar ficheiro .vnd
        /// - pl: Zapisz plik .vnd
        /// - nl: .vnd-bestand bewaren
        /// - ru: Сохранить файл .vnd
        static let downloadInvitation: String.LocalizationValue = "button_download_invitation"
        /// Share invitation
        ///
        /// Key: `button_native_share`
        ...
        /// - nl: Uitnodiging delen
        /// - ru: Поделиться приглашением
        static let nativeShare: String.LocalizationValue = "button_native_share"
        /// Open Settings
        ///
        /// Key: `button_open_settings`
        ...
        static let openSettings: String.LocalizationValue = "button_open_settings"
        /// Receive
        ///
        /// Key: `button_receive`
        ...
        /// - nl: Ontvangen
        /// - ru: Получить
        static let receive: String.LocalizationValue = "button_receive"
        /// Start receiving
        ///
        /// Key: `button_receive_files`
        ...
        /// - de: Empfang starten
        /// - pt: Começar a receber
        /// - pl: Rozpocznij odbieranie
        /// - nl: Ontvangen starten
        /// - ru: Начать получение
        static let receiveFiles: String.LocalizationValue = "button_receive_files"
        /// Refuse
        ///
        /// Key: `button_refuse`
        ...
        /// - nl: Weigeren
        /// - ru: Отклонить
        static let refuse: String.LocalizationValue = "button_refuse"
        /// Remove file
        ///
        /// Key: `button_remove_file`
        ...
        /// - ru: Удалить файл
        static let removeFile: String.LocalizationValue = "button_remove_file"
        /// Use default
        ///
        /// Key: `button_reset_default`
        ...
        /// - pl: Użyj domyślnego
        /// - nl: Standaard gebruiken
        /// - ru: По умолчанию
        static let resetDefault: String.LocalizationValue = "button_reset_default"
        /// Retry
        ///
        /// Key: `button_retry`
        ...
        /// - nl: Opnieuw proberen
        /// - ru: Повторить
        static let retry: String.LocalizationValue = "button_retry"
        /// Start sharing
        ///
        /// Key: `button_share_file`
        ...
        /// - pl: Rozpocznij udostępnianie
        /// - nl: Delen starten
        /// - ru: Начать общий доступ
        static let shareFile: String.LocalizationValue = "button_share_file"
        /// Preparing transfer…
        ///
        /// Key: `button_sharing_file`
        ...
        /// - pl: Przygotowywanie transferu…
        /// - nl: Overdracht voorbereiden…
        /// - ru: Подготовка передачи…
        static let sharingFile: String.LocalizationValue = "button_sharing_file"
        /// Show in Files
        ///
        /// Key: `button_show_in_files`
        ...
        /// - pt: Mostrar em Ficheiros
        /// - pl: Pokaż w Plikach
        /// - nl: Toon in Bestanden
        /// - ru: Показать в Файлах
        static let showInFiles: String.LocalizationValue = "button_show_in_files"
        /// Write to NFC tag
        ///
        /// Key: `button_write_nfc`
        ...
        /// - pt: Escrever em etiqueta NFC
        /// - pl: Zapisz na tagu NFC
        /// - nl: Naar NFC-tag schrijven
        /// - ru: Записать на NFC-метку
        static let writeNfc: String.LocalizationValue = "button_write_nfc"
    }
    enum Device {
        /// Device model
        ///
        /// Key: `device_model_title`
        ...
        static let modelTitle: String.LocalizationValue = "device_model_title"
        /// Device name
        ///
        /// Key: `device_name_title`
        ...
        /// - nl: Apparaatnaam
        /// - ru: Имя устройства
        static let nameTitle: String.LocalizationValue = "device_name_title"
    }
    enum Diagnostics {
        ...
        static let description: String.LocalizationValue = "diagnostics_description"
        /// Diagnostics sharing is off.
        ///
        /// Key: `diagnostics_disabled_message`
        ...
        static let disabledMessage: String.LocalizationValue = "diagnostics_disabled_message"
        /// Diagnostics sharing is on.
        ///
        /// Key: `diagnostics_enabled_message`
        ...
        static let enabledMessage: String.LocalizationValue = "diagnostics_enabled_message"
        /// Share diagnostics
        ///
        /// Key: `diagnostics_title`
        ...
        static let title: String.LocalizationValue = "diagnostics_title"
    }
    enum Error {
        ...
        /// - pl: Do zeskanowania kodu QR wymagany jest dostęp do aparatu.
        /// - nl: Voor het scannen van een QR-code is toegang tot de camera vereist.
        /// - ru: Для сканирования QR-кода требуется доступ к камере.
        static let camera: String.LocalizationValue = "error_camera"
        /// Could not load device information.
        ///
        /// Key: `error_device_info`
        ...
        /// - pt: Não foi possível carregar as informações do dispositivo.
        /// - pl: Nie udało się wczytać informacji o urządzeniu.
        /// - nl: Apparaatgegevens konden niet worden geladen.
        /// - ru: Не удалось загрузить сведения об устройстве.
        static let deviceInfo: String.LocalizationValue = "error_device_info"
        /// A file with the same name already exists in the destination. Choose another folder or remove the existing file.
        ///
        /// Key: `error_destination_exists`
        ...
        /// - it: Nella destinazione esiste già un file con lo stesso nome. Scelga un’altra cartella o rimuova il file esistente.
        ...
        static let destinationExists: String.LocalizationValue = "error_destination_exists"
        /// VniDrop could not access the selected files or folder. Check permissions and try again.
        ///
        /// Key: `error_filesystem`
        ...
        /// - pt: O VniDrop não conseguiu aceder aos ficheiros ou à pasta selecionados. Verifique as permissões e tente novamente.
        /// - pl: VniDrop nie mógł uzyskać dostępu do wybranych plików lub folderu. Sprawdź uprawnienia i spróbuj ponownie.
        /// - nl: VniDrop kon geen toegang krijgen tot de geselecteerde bestanden of map. Controleer de machtigingen en probeer het opnieuw.
        /// - ru: VniDrop не удалось получить доступ к выбранным файлам или папке. Проверьте разрешения и повторите попытку.
        static let filesystem: String.LocalizationValue = "error_filesystem"
        ...
        static let generic: String.LocalizationValue = "error_generic"
        /// VniDrop could not finish starting up. Close the app and try again.
        ///
        /// Key: `error_initialization`
        ...
        /// - pt: O VniDrop não conseguiu concluir o arranque. Feche a app e tente novamente.
        /// - pl: VniDrop nie mógł dokończyć uruchamiania. Zamknij aplikację i spróbuj ponownie.
        /// - nl: VniDrop kon het opstarten niet voltooien. Sluit de app en probeer het opnieuw.
        /// - ru: VniDrop не удалось завершить запуск. Закройте приложение и повторите попытку.
        static let initialization: String.LocalizationValue = "error_initialization"
        /// Some transfer information is invalid. Review your selection or ask the sender to share again.
        ///
        ...
        /// - fr: Certaines informations du transfert ne sont pas valides. Vérifiez votre sélection ou demandez à l’expéditeur de partager à nouveau.
        ...
        static let invalidInput: String.LocalizationValue = "error_invalid_input"
        /// This invitation could not be read. Ask the sender for a new one.
        ///
        /// Key: `error_invalid_ticket`
        ...
        /// - pt: Não foi possível ler este convite. Peça um novo ao remetente.
        /// - pl: Nie udało się odczytać tego zaproszenia. Poproś nadawcę o nowe.
        /// - nl: Deze uitnodiging kon niet worden gelezen. Vraag de afzender om een nieuwe.
        /// - ru: Не удалось прочитать это приглашение. Попросите отправителя прислать новое.
        static let invalidTicket: String.LocalizationValue = "error_invalid_ticket"
        /// That invitation is empty. Try opening it again.
        ///
        /// Key: `error_invitation_empty`
        ...
        /// - pt: Esse convite está vazio. Tente abri-lo novamente.
        /// - pl: To zaproszenie jest puste. Spróbuj otworzyć je ponownie.
        /// - nl: Die uitnodiging is leeg. Probeer deze opnieuw te openen.
        /// - ru: Это приглашение пустое. Попробуйте открыть его снова.
        static let invitationEmpty: String.LocalizationValue = "error_invitation_empty"
        /// The native VniDrop library is missing from this build.
        ///
        /// Key: `error_missing_native_library`
        ...
        /// - pt: A biblioteca nativa do VniDrop está em falta nesta compilação.
        /// - pl: W tej kompilacji brakuje natywnej biblioteki VniDrop.
        /// - nl: De native VniDrop-bibliotheek ontbreekt in deze build.
        /// - ru: В этой сборке отсутствует нативная библиотека VniDrop.
        static let missingNativeLibrary: String.LocalizationValue = "error_missing_native_library"
        /// VniDrop could not reach the sender. Check the connection on both devices and try again.
        ///
        /// Key: `error_network`
        ...
        /// - fr: VniDrop n’a pas pu joindre l’expéditeur. Vérifiez la connexion sur les deux appareils et réessayez.
        ...
        static let network: String.LocalizationValue = "error_network"
        ...
        /// - pt: Não foi possível utilizar esta etiqueta NFC. Tente outra.
        /// - pl: Nie udało się użyć tego tagu NFC. Spróbuj innego.
        /// - nl: Deze NFC-tag kon niet worden gebruikt. Probeer een andere.
        /// - ru: Не удалось использовать эту NFC-метку. Попробуйте другую.
        static let nfc: String.LocalizationValue = "error_nfc"
        ...
        /// - pt: O remetente não aprovou esta transferência, ou foi recusada.
        /// - pl: Nadawca nie zatwierdził tego transferu lub został on odrzucony.
        /// - nl: De afzender heeft deze overdracht niet goedgekeurd, of deze is geweigerd.
        /// - ru: Отправитель не одобрил эту передачу, или она была отклонена.
        static let permission: String.LocalizationValue = "error_permission"
        /// The relay settings are not valid. Check the relay addresses in Settings.
        ///
        /// Key: `error_relay_configuration`
        /// Context: Error: the configured relay settings are invalid.
        ///
        /// - en: The relay settings are not valid. Check the relay addresses in Settings.
        /// - fr: Les réglages des relais ne sont pas valides. Vérifiez les adresses des relais dans les Réglages.
        /// - es: Los ajustes de los relés no son válidos. Compruebe las direcciones de los relés en Ajustes.
        /// - it: Le impostazioni dei relay non sono valide. Controlli gli indirizzi dei relay nelle Impostazioni.
        /// - de: Die Relay-Einstellungen sind ungültig. Überprüfen Sie die Relay-Adressen in den Einstellungen.
        /// - pt: As definições dos retransmissores não são válidas. Verifique os endereços dos retransmissores nas Definições.
        /// - pl: Ustawienia przekaźników są nieprawidłowe. Sprawdź adresy przekaźników w Ustawieniach.
        /// - nl: De relay-instellingen zijn ongeldig. Controleer de relayadressen in Instellingen.
        /// - ru: Настройки ретрансляторов недействительны. Проверьте адреса ретрансляторов в «Настройках».
        static let relayConfiguration: String.LocalizationValue = "error_relay_configuration"
        /// Couldn't connect directly. Use the same network as the other device, or enable relays in Settings.
        ///
        /// Key: `error_relay_direct_failed`
        /// Context: Error: a direct connection failed while relays are disabled (local-network only).
        ///
        /// - en: Couldn't connect directly. Use the same network as the other device, or enable relays in Settings.
        /// - fr: Connexion directe impossible. Utilisez le même réseau que l’autre appareil, ou activez les relais dans les Réglages.
        /// - es: No se pudo conectar directamente. Use la misma red que el otro dispositivo o active los relés en Ajustes.
        /// - it: Impossibile connettersi direttamente. Usi la stessa rete dell’altro dispositivo o attivi i relay nelle Impostazioni.
        /// - de: Direkte Verbindung nicht möglich. Verwenden Sie dasselbe Netzwerk wie das andere Gerät oder aktivieren Sie Relays in den Einstellungen.
        /// - pt: Não foi possível ligar diretamente. Utilize a mesma rede que o outro dispositivo ou ative os retransmissores nas Definições.
        /// - pl: Nie można połączyć się bezpośrednio. Użyj tej samej sieci co drugie urządzenie lub włącz przekaźniki w Ustawieniach.
        /// - nl: Kon niet rechtstreeks verbinden. Gebruik hetzelfde netwerk als het andere apparaat of schakel relays in bij Instellingen.
        /// - ru: Не удалось подключиться напрямую. Используйте ту же сеть, что и другое устройство, или включите ретрансляторы в «Настройках».
        static let relayDirectFailed: String.LocalizationValue = "error_relay_direct_failed"
        ...
        /// - pt: O VniDrop não conseguiu guardar os dados da transferência neste dispositivo.
        /// - pl: VniDrop nie mógł zapisać danych transferu na tym urządzeniu.
        /// - nl: VniDrop kon de overdrachtsgegevens niet op dit apparaat bewaren.
        /// - ru: VniDrop не удалось сохранить данные передачи на этом устройстве.
        static let repository: String.LocalizationValue = "error_repository"
        /// Could not open the selected item. Try choosing it again.
        ///
        /// Key: `error_selection_failed`
        ...
        /// - pt: Não foi possível abrir o item selecionado. Tente escolhê-lo novamente.
        /// - pl: Nie udało się otworzyć wybranego elementu. Spróbuj wybrać go ponownie.
        /// - nl: Het geselecteerde item kon niet worden geopend. Probeer het opnieuw te kiezen.
        /// - ru: Не удалось открыть выбранный объект. Попробуйте выбрать его снова.
        static let selectionFailed: String.LocalizationValue = "error_selection_failed"
        /// Select at least one item to share.
        ///
        /// Key: `error_share_empty`
        ...
        /// - pt: Selecione pelo menos um item para partilhar.
        /// - pl: Wybierz co najmniej jeden element do udostępnienia.
        /// - nl: Selecteer minstens één item om te delen.
        /// - ru: Выберите хотя бы один объект для отправки.
        static let shareEmpty: String.LocalizationValue = "error_share_empty"
        /// VniDrop could not open its network sockets on this device.
        ///
        /// Key: `error_socket_bind`
        ...
        /// - pt: O VniDrop não conseguiu abrir os seus sockets de rede neste dispositivo.
        /// - pl: VniDrop nie mógł otworzyć gniazd sieciowych na tym urządzeniu.
        /// - nl: VniDrop kon zijn netwerksockets niet openen op dit apparaat.
        /// - ru: VniDrop не удалось открыть сетевые сокеты на этом устройстве.
        static let socketBind: String.LocalizationValue = "error_socket_bind"
        /// VniDrop is still starting. Open the invitation again in a moment.
        ///
        /// Key: `error_starting_up`
        ...
        /// - pt: O VniDrop ainda está a iniciar. Abra o convite novamente dentro de momentos.
        /// - pl: VniDrop jeszcze się uruchamia. Otwórz zaproszenie ponownie za chwilę.
        /// - nl: VniDrop is nog aan het opstarten. Open de uitnodiging zo meteen opnieuw.
        /// - ru: VniDrop ещё запускается. Откройте приглашение снова через мгновение.
        static let startingUp: String.LocalizationValue = "error_starting_up"
        /// There is not enough storage space to save this transfer. Free up space and try again.
        ///
        /// Key: `error_storage_full`
        ...
        /// - fr: L’espace de stockage est insuffisant pour enregistrer ce transfert. Libérez de l’espace et réessayez.
        ...
        static let storageFull: String.LocalizationValue = "error_storage_full"
        /// The transfer data could not be processed. Ask the sender to share it again.
        ///
        /// Key: `error_transfer`
        ...
        /// - fr: Les données du transfert n’ont pas pu être traitées. Demandez à l’expéditeur de les partager à nouveau.
        ...
        static let transfer: String.LocalizationValue = "error_transfer"
    }
    enum Field {
        /// Receiver name
        ///
        /// Key: `field_receiver_name`
        ...
        /// - ru: Имя получателя
        static let receiverName: String.LocalizationValue = "field_receiver_name"
        /// Sender name
        ///
        ...
        /// - pl: Nazwa nadawcy
        /// - nl: Naam van afzender
        /// - ru: Имя отправителя
        static let senderName: String.LocalizationValue = "field_sender_name"
        /// Transfer name
        ///
        /// Key: `field_transfer_name`
        ...
        /// - de: Übertragungsname
        /// - pt: Nome da transferência
        /// - pl: Nazwa transferu
        /// - nl: Naam van overdracht
        /// - ru: Название передачи
        static let transferName: String.LocalizationValue = "field_transfer_name"
        /// Display name
        ///
        /// Key: `field_username`
        ...
        /// - de: Anzeigename
        /// - pt: Nome a apresentar
        /// - pl: Nazwa wyświetlana
        /// - nl: Weergavenaam
        /// - ru: Отображаемое имя
        static let username: String.LocalizationValue = "field_username"
    }
    enum Folder {
        /// Permission needed
        ///
        /// Key: `folder_status_permission_required`
        ...
        /// - nl: Machtiging vereist
        /// - ru: Требуется разрешение
        static let statusPermissionRequired: String.LocalizationValue = "folder_status_permission_required"
        /// Unavailable
        ///
        /// Key: `folder_status_unavailable`
        ...
        /// - nl: Niet beschikbaar
        /// - ru: Недоступно
        static let statusUnavailable: String.LocalizationValue = "folder_status_unavailable"
        /// Checking folder…
        ///
        /// Key: `folder_status_validating`
        ...
        /// - pt: A verificar a pasta…
        /// - pl: Sprawdzanie folderu…
        /// - nl: Map controleren…
        /// - ru: Проверка папки…
        static let statusValidating: String.LocalizationValue = "folder_status_validating"
        /// Ready
        ///
        /// Key: `folder_status_writable`
    ...
    enum Metadata {
        ...
        /// - nl: Bestanden
        /// - ru: Файлы
        static let files: String.LocalizationValue = "metadata_files"
        /// Size
        ///
        /// Key: `metadata_size`
        ...
        /// - nl: Grootte
        /// - ru: Размер
        static let size: String.LocalizationValue = "metadata_size"
        /// Status
        ///
        /// Key: `metadata_status`
        ...
        /// - nl: Status
        /// - ru: Статус
        static let status: String.LocalizationValue = "metadata_status"
    }
    enum Nav {
        /// Receive
        ///
        ...
        /// - nl: Ontvangen
        /// - ru: Получить
        static let receive: String.LocalizationValue = "nav_receive"
        /// Send
        ///
        /// Key: `nav_send`
        ...
        /// - nl: Versturen
        /// - ru: Отправить
        static let send: String.LocalizationValue = "nav_send"
        /// Settings
        ///
        /// Key: `nav_settings`
        ...
        /// - nl: Instellingen
        /// - ru: Настройки
        static let settings: String.LocalizationValue = "nav_settings"
    }
    enum Network {
        /// Network
        ///
        ...
        /// - nl: Netwerk
        /// - ru: Сеть
        static let title: String.LocalizationValue = "network_title"
    }
    enum Notifications {
        ...
        static let description: String.LocalizationValue = "notifications_description"
        /// Notifications enabled.
        ///
        /// Key: `notifications_enabled_message`
        ...
        static let enabledMessage: String.LocalizationValue = "notifications_enabled_message"
        /// Allow notifications
        ///
        /// Key: `notifications_local_title`
        ...
        static let localTitle: String.LocalizationValue = "notifications_local_title"
        /// Notifications are turned off for VniDrop. You can enable them in Settings.
        ///
        /// Key: `notifications_permission_denied`
        ...
        /// - pt: As notificações estão desativadas para o VniDrop. Pode ativá-las nas Definições.
        /// - pl: Powiadomienia są wyłączone dla VniDrop. Możesz je włączyć w Ustawieniach.
        /// - nl: Meldingen zijn uitgeschakeld voor VniDrop. U kunt ze inschakelen in Instellingen.
        /// - ru: Уведомления отключены для VniDrop. Вы можете включить их в Настройках.
        static let permissionDenied: String.LocalizationValue = "notifications_permission_denied"
        /// Could not open notification settings.
        ///
        /// Key: `notifications_settings_open_failed`
        ...
        /// - pt: Não foi possível abrir as definições de notificações.
        /// - pl: Nie udało się otworzyć ustawień powiadomień.
        /// - nl: De meldingsinstellingen konden niet worden geopend.
        /// - ru: Не удалось открыть настройки уведомлений.
        static let settingsOpenFailed: String.LocalizationValue = "notifications_settings_open_failed"
        /// Notifications
        ///
        ...
        /// - nl: Meldingen
        /// - ru: Уведомления
        static let title: String.LocalizationValue = "notifications_title"
        /// Notifications are not available on this device.
        ///
        /// Key: `notifications_unsupported`
        ...
        /// - pt: As notificações não estão disponíveis neste dispositivo.
        /// - pl: Powiadomienia nie są dostępne na tym urządzeniu.
        /// - nl: Meldingen zijn niet beschikbaar op dit apparaat.
        /// - ru: Уведомления недоступны на этом устройстве.
        static let unsupported: String.LocalizationValue = "notifications_unsupported"
    }
    enum Os {
        /// Operating system
        ///
        /// Key: `os_version_title`
        ...
        static let versionTitle: String.LocalizationValue = "os_version_title"
    }
    enum Preferences {
        /// Save received transfers to
        ///
        /// Key: `preferences_receive_folder_title`
        ...
        /// - pt: Guardar as transferências recebidas em
        /// - pl: Zapisuj odebrane transfery w
        /// - nl: Ontvangen overdrachten bewaren in
        /// - ru: Сохранять полученные передачи в
        static let receiveFolderTitle: String.LocalizationValue = "preferences_receive_folder_title"
        /// Preferences
        ///
        ...
        /// - nl: Voorkeuren
        /// - ru: Параметры
        static let title: String.LocalizationValue = "preferences_title"
    }
    enum Progress {
        /// Cancelled
        ///
        /// Key: `progress_cancelled`
        ...
        /// - nl: Geannuleerd
        /// - ru: Отменено
        static let cancelled: String.LocalizationValue = "progress_cancelled"
        /// Completed
        ///
        ...
        /// - nl: Voltooid
        /// - ru: Завершено
        static let completed: String.LocalizationValue = "progress_completed"
        /// Connected
        ///
        /// Key: `progress_connected`
        ...
        /// - nl: Verbonden
        /// - ru: Подключено
        static let connected: String.LocalizationValue = "progress_connected"
        /// Connecting
        ///
        /// Key: `progress_connecting`
        ...
        /// - nl: Verbinden
        /// - ru: Подключение
        static let connecting: String.LocalizationValue = "progress_connecting"
        /// Downloading
        ///
        /// Key: `progress_downloading`
        ...
        /// - nl: Downloaden
        /// - ru: Загрузка
        static let downloading: String.LocalizationValue = "progress_downloading"
        /// Failed
        ///
        /// Key: `progress_failed`
        ...
        /// - nl: Mislukt
        /// - ru: Ошибка
        static let failed: String.LocalizationValue = "progress_failed"
        /// Getting ready
        ///
        /// Key: `progress_getting_ready`
        ...
        /// - nl: Klaarmaken
        /// - ru: Подготовка
        static let gettingReady: String.LocalizationValue = "progress_getting_ready"
        /// Transfer interrupted
        ///
        /// Key: `progress_interrupted`
        ...
        /// - nl: Overdracht onderbroken
        /// - ru: Передача прервана
        static let interrupted: String.LocalizationValue = "progress_interrupted"
        /// Preparing
        ///
        /// Key: `progress_preparing`
        ...
        /// - nl: Voorbereiden
        /// - ru: Подготовка
        static let preparing: String.LocalizationValue = "progress_preparing"
        /// Ready
        ///
        /// Key: `progress_ready`
        ...
        /// - nl: Gereed
        /// - ru: Готово
        static let ready: String.LocalizationValue = "progress_ready"
        /// Receiving
        ///
        /// Key: `progress_receiving`
        ...
        /// - nl: Ontvangen
        /// - ru: Получение
        static let receiving: String.LocalizationValue = "progress_receiving"
        /// Requesting access
        ///
        /// Key: `progress_requesting_access`
        ...
        /// - ru: Запрос доступа
        static let requestingAccess: String.LocalizationValue = "progress_requesting_access"
        /// Saving
        ///
        /// Key: `progress_saving`
        ...
        /// - nl: Bewaren
        /// - ru: Сохранение
        static let saving: String.LocalizationValue = "progress_saving"
        /// Sending
        ///
        /// Key: `progress_sending`
        ...
        /// - nl: Versturen
        /// - ru: Отправка
        static let sending: String.LocalizationValue = "progress_sending"
        /// Sending to {count}
        ///
        /// Key: `progress_sending_to_count`
        ...
        /// - it: Invio a {count}
        /// - de: Senden an {count}
        /// - pt: A enviar para {count}
        /// - pl: Wysyłanie do {count}
        /// - nl: Versturen naar {count}
        /// - ru: Отправка получателям: {count}
        static func sendingToCount(count: Int) -> String {
            String(format: String(localized: "progress_sending_to_count"), count)
        }
        /// Ready to share
        ///
        /// Key: `progress_share_ready`
        ...
        /// - pt: Pronto para partilhar
        /// - pl: Gotowe do udostępnienia
        /// - nl: Klaar om te delen
        /// - ru: Готово к отправке
        static let shareReady: String.LocalizationValue = "progress_share_ready"
        /// Working…
        ///
        /// Key: `progress_working`
        ...
        /// - nl: Bezig…
        /// - ru: Обработка…
        static let working: String.LocalizationValue = "progress_working"
    }
    enum Receive {
        /// Choose the invitation method available to you.
        ///
        /// Key: `receive_choose_method_body`
        ...
        /// - pt: Escolha o método de convite ao seu dispor.
        /// - pl: Wybierz dostępną metodę zaproszenia.
        /// - nl: Kies de uitnodigingsmethode die u ter beschikking staat.
        /// - ru: Выберите доступный вам способ приглашения.
        static let chooseMethodBody: String.LocalizationValue = "receive_choose_method_body"
        /// How would you like to connect?
        ///
        /// Key: `receive_choose_method_title`
        ...
        /// - pt: Como pretende ligar-se?
        /// - pl: Jak chcesz się połączyć?
        /// - nl: Hoe wilt u verbinding maken?
        /// - ru: Как вы хотите подключиться?
        static let chooseMethodTitle: String.LocalizationValue = "receive_choose_method_title"
        /// Clear history
        ///
        /// Key: `receive_clear_history`
        ...
        /// - ru: Очистить историю
        static let clearHistory: String.LocalizationValue = "receive_clear_history"
        ...
        ///
        /// Key: `receive_clear_history_description`
        ...
        /// - pt: Todas as receções concluídas, falhadas e canceladas serão removidas do histórico do VniDrop. Os ficheiros descarregados permanecerão neste dispositivo.
        /// - pl: Wszystkie ukończone, nieudane i anulowane odbiory zostaną usunięte z historii VniDrop. Pobrane pliki pozostaną na tym urządzeniu.
        /// - nl: Alle voltooide, mislukte en geannuleerde ontvangsten worden uit de geschiedenis van VniDrop verwijderd. Gedownloade bestanden blijven op dit apparaat.
        /// - ru: Все завершённые, неудачные и отменённые получения будут удалены из истории VniDrop. Загруженные файлы останутся на этом устройстве.
        static let clearHistoryDescription: String.LocalizationValue = "receive_clear_history_description"
        /// Clear receive history?
        ///
        /// Key: `receive_clear_history_title`
        ...
        /// - pt: Limpar o histórico de receção?
        /// - pl: Wyczyścić historię odbioru?
        /// - nl: Ontvangstgeschiedenis wissen?
        /// - ru: Очистить историю получения?
        static let clearHistoryTitle: String.LocalizationValue = "receive_clear_history_title"
        /// Transfer received.
        ///
        /// Key: `receive_completed`
        ...
        static let completed: String.LocalizationValue = "receive_completed"
        /// “{transferName}” will be removed from VniDrop’s history. The downloaded file will remain on this device.
        ///
        /// Key: `receive_delete_history_description`
        ...
        static func deleteHistoryDescription(transferName: String) -> String {
            String(format: String(localized: "receive_delete_history_description"), transferName)
        }
        /// Delete from receive history
        ///
        /// Key: `receive_delete_history_item`
        ...
        /// - pt: Eliminar do histórico de receção
        /// - pl: Usuń z historii odbioru
        /// - nl: Uit ontvangstgeschiedenis verwijderen
        /// - ru: Удалить из истории получения
        static let deleteHistoryItem: String.LocalizationValue = "receive_delete_history_item"
        /// Remove from history?
        ///
        /// Key: `receive_delete_history_title`
        ...
        static let deleteHistoryTitle: String.LocalizationValue = "receive_delete_history_title"
        /// Open a VniDrop invitation, scan a QR code, or hold near an NFC tag.
        ///
        /// Key: `receive_empty_body`
        ...
        /// - pt: Abra um convite do VniDrop, leia um código QR ou aproxime uma etiqueta NFC.
        /// - pl: Otwórz zaproszenie VniDrop, zeskanuj kod QR lub zbliż tag NFC.
        /// - nl: Open een VniDrop-uitnodiging, scan een QR-code of houd het apparaat bij een NFC-tag.
        /// - ru: Откройте приглашение VniDrop, отсканируйте QR-код или поднесите NFC-метку.
        static let emptyBody: String.LocalizationValue = "receive_empty_body"
        /// Nothing received yet
        ///
        /// Key: `receive_empty_title`
        ...
        /// - pt: Ainda não recebeu nada
        /// - pl: Nic jeszcze nie odebrano
        /// - nl: Nog niets ontvangen
        /// - ru: Пока ничего не получено
        static let emptyTitle: String.LocalizationValue = "receive_empty_title"
        /// Receive history cleared.
        ///
        /// Key: `receive_history_cleared`
        ...
        /// - pt: Histórico de receção limpo.
        /// - pl: Historia odbioru wyczyszczona.
        /// - nl: Ontvangstgeschiedenis gewist.
        /// - ru: История получения очищена.
        static let historyCleared: String.LocalizationValue = "receive_history_cleared"
        /// History
        ///
        /// Key: `receive_history_title`
        ...
        /// - nl: Geschiedenis
        /// - ru: История
        static let historyTitle: String.LocalizationValue = "receive_history_title"
        /// Open a .vnd invitation
        ///
        /// Key: `receive_method_file`
        ...
        /// - pt: Abrir um convite .vnd
        /// - pl: Otwórz zaproszenie .vnd
        /// - nl: Een .vnd-uitnodiging openen
        /// - ru: Открыть приглашение .vnd
        static let methodFile: String.LocalizationValue = "receive_method_file"
        /// Choose an invitation saved or shared to this device.
        ///
        /// Key: `receive_method_file_description`
        ...
        /// - pt: Escolha um convite guardado ou partilhado neste dispositivo.
        /// - pl: Wybierz zaproszenie zapisane lub udostępnione na tym urządzeniu.
        /// - nl: Kies een uitnodiging die op dit apparaat is bewaard of gedeeld.
        /// - ru: Выберите приглашение, сохранённое или отправленное на это устройство.
        static let methodFileDescription: String.LocalizationValue = "receive_method_file_description"
        /// Read NFC tag
        ///
        /// Key: `receive_method_nfc`
        ...
        /// - pl: Odczytaj tag NFC
        /// - nl: NFC-tag lezen
        /// - ru: Прочитать NFC-метку
        static let methodNfc: String.LocalizationValue = "receive_method_nfc"
        /// Hold this device near the sender’s invitation tag.
        ///
        /// Key: `receive_method_nfc_description`
        ...
        /// - pt: Aproxime este dispositivo da etiqueta de convite do remetente.
        /// - pl: Zbliż to urządzenie do tagu zaproszenia nadawcy.
        /// - nl: Houd dit apparaat bij de uitnodigingstag van de afzender.
        /// - ru: Поднесите это устройство к метке приглашения отправителя.
        static let methodNfcDescription: String.LocalizationValue = "receive_method_nfc_description"
        /// Scan QR code
        ///
        /// Key: `receive_method_scan`
        ...
        static let methodScan: String.LocalizationValue = "receive_method_scan"
        /// Use the camera to scan the sender’s VniDrop code.
        ///
        /// Key: `receive_method_scan_description`
        ...
        /// - pt: Use a câmara para ler o código VniDrop do remetente.
        /// - pl: Użyj aparatu, aby zeskanować kod VniDrop nadawcy.
        /// - nl: Gebruik de camera om de VniDrop-code van de afzender te scannen.
        /// - ru: Используйте камеру, чтобы отсканировать код VniDrop отправителя.
        static let methodScanDescription: String.LocalizationValue = "receive_method_scan_description"
        /// Transfers you’ve received on this device.
        ///
        /// Key: `receive_new_subtitle`
        ...
        /// - pt: Transferências que recebeu neste dispositivo.
        /// - pl: Transfery odebrane na tym urządzeniu.
        /// - nl: Overdrachten die u op dit apparaat hebt ontvangen.
        /// - ru: Передачи, полученные на этом устройстве.
        static let newSubtitle: String.LocalizationValue = "receive_new_subtitle"
        /// Hold near the NFC tag…
        ///
        /// Key: `receive_nfc_waiting`
        ...
        /// - pt: Aproxime da etiqueta NFC…
        /// - pl: Zbliż do tagu NFC…
        /// - nl: Houd bij de NFC-tag…
        /// - ru: Поднесите к NFC-метке…
        static let nfcWaiting: String.LocalizationValue = "receive_nfc_waiting"
        /// Couldn’t open VniDrop in Files.
        ///
        /// Key: `receive_open_files_failed`
        ...
        /// - pt: Não foi possível abrir o VniDrop em Ficheiros.
        /// - pl: Nie udało się otworzyć VniDrop w Plikach.
        /// - nl: VniDrop kon niet worden geopend in Bestanden.
        /// - ru: Не удалось открыть VniDrop в Файлах.
        static let openFilesFailed: String.LocalizationValue = "receive_open_files_failed"
        /// Review transfer
        ///
        /// Key: `receive_review_title`
        ...
        /// - pl: Przejrzyj transfer
        /// - nl: Overdracht controleren
        /// - ru: Проверить передачу
        static let reviewTitle: String.LocalizationValue = "receive_review_title"
        /// Receive
        ///
        /// Key: `receive_title`
        ...
        /// - nl: Ontvangen
        /// - ru: Получить
        static let title: String.LocalizationValue = "receive_title"
        /// VniDrop transfer
        ///
        /// Key: `receive_unknown_transfer`
        ...
        /// - pt: Transferência VniDrop
        /// - pl: Transfer VniDrop
        /// - nl: VniDrop-overdracht
        /// - ru: Передача VniDrop
        static let unknownTransfer: String.LocalizationValue = "receive_unknown_transfer"
    }
    enum Relay {
        /// Apply addresses
        ///
        /// Key: `relay_custom_apply`
        /// Context: Relay settings — button that validates and saves the entered relay addresses.
        ///
        /// - en: Apply addresses
        /// - fr: Appliquer les adresses
        /// - es: Aplicar direcciones
        /// - it: Applica indirizzi
        /// - de: Adressen übernehmen
        /// - pt: Aplicar endereços
        /// - pl: Zastosuj adresy
        /// - nl: Adressen toepassen
        /// - ru: Применить адреса
        static let customApply: String.LocalizationValue = "relay_custom_apply"
        /// One address per line, starting with https://. Relays that require an access token are not supported yet.
        ///
        /// Key: `relay_custom_urls_help`
        /// Context: Relay settings — format help under the custom relay address field.
        ///
        /// - en: One address per line, starting with https://. Relays that require an access token are not supported yet.
        /// - fr: Une adresse par ligne, commençant par https://. Les relais nécessitant un jeton d’accès ne sont pas encore pris en charge.
        /// - es: Una dirección por línea, empezando por https://. Los relés que requieren un token de acceso todavía no son compatibles.
        /// - it: Un indirizzo per riga, che inizi con https://. I relay che richiedono un token di accesso non sono ancora supportati.
        /// - de: Eine Adresse pro Zeile, beginnend mit https://. Relays, die ein Zugriffstoken erfordern, werden noch nicht unterstützt.
        /// - pt: Um endereço por linha, começando por https://. Os retransmissores que exigem um token de acesso ainda não são suportados.
        /// - pl: Jeden adres w wierszu, zaczynający się od https://. Przekaźniki wymagające tokena dostępu nie są jeszcze obsługiwane.
        /// - nl: Eén adres per regel, beginnend met https://. Relays die een toegangstoken vereisen, worden nog niet ondersteund.
        /// - ru: По одному адресу в строке, начиная с https://. Ретрансляторы, требующие токен доступа, пока не поддерживаются.
        static let customUrlsHelp: String.LocalizationValue = "relay_custom_urls_help"
        /// Relay addresses
        ///
        /// Key: `relay_custom_urls_label`
        /// Context: Relay settings — label for the custom relay address field.
        ///
        /// - en: Relay addresses
        /// - fr: Adresses des relais
        /// - es: Direcciones de los relés
        /// - it: Indirizzi dei relay
        /// - de: Relay-Adressen
        /// - pt: Endereços dos retransmissores
        /// - pl: Adresy przekaźników
        /// - nl: Relayadressen
        /// - ru: Адреса ретрансляторов
        static let customUrlsLabel: String.LocalizationValue = "relay_custom_urls_label"
        /// Enter at least one relay address.
        ///
        /// Key: `relay_error_no_urls`
        /// Context: Relay settings — validation error when the custom address field is empty.
        ///
        /// - en: Enter at least one relay address.
        /// - fr: Saisissez au moins une adresse de relais.
        /// - es: Introduzca al menos una dirección de relé.
        /// - it: Inserisca almeno un indirizzo relay.
        /// - de: Geben Sie mindestens eine Relay-Adresse ein.
        /// - pt: Introduza pelo menos um endereço de retransmissor.
        /// - pl: Wpisz co najmniej jeden adres przekaźnika.
        /// - nl: Voer minstens één relayadres in.
        /// - ru: Введите хотя бы один адрес ретранслятора.
        static let errorNoUrls: String.LocalizationValue = "relay_error_no_urls"
        /// Custom relays
        ///
        /// Key: `relay_mode_custom`
        /// Context: Relay settings — option using relay servers the user supplies.
        ///
        /// - en: Custom relays
        /// - fr: Relais personnalisés
        /// - es: Relés personalizados
        /// - it: Relay personalizzati
        /// - de: Eigene Relays
        /// - pt: Retransmissores personalizados
        /// - pl: Własne przekaźniki
        /// - nl: Aangepaste relays
        /// - ru: Свои ретрансляторы
        static let modeCustom: String.LocalizationValue = "relay_mode_custom"
        /// Use your own relay servers instead of the default ones. Other people you transfer with may connect through your relay.
        ///
        /// Key: `relay_mode_custom_description`
        /// Context: Relay settings — explains the custom relay option, including that peers may connect through the user's relay.
        ///
        /// - en: Use your own relay servers instead of the default ones. Other people you transfer with may connect through your relay.
        /// - fr: Utilisez vos propres serveurs relais au lieu de ceux par défaut. Les personnes avec qui vous échangez peuvent se connecter via votre relais.
        /// - es: Use sus propios servidores de relé en lugar de los predeterminados. Las personas con las que transfiera archivos pueden conectarse a través de su relé.
        /// - it: Usi i suoi server relay al posto di quelli predefiniti. Le persone con cui scambia file possono connettersi tramite il suo relay.
        /// - de: Verwenden Sie Ihre eigenen Relay-Server statt der Standardserver. Personen, mit denen Sie Dateien austauschen, können sich über Ihr Relay verbinden.
        /// - pt: Utilize os seus próprios servidores de retransmissão em vez dos predefinidos. As pessoas com quem troca ficheiros podem ligar-se através do seu retransmissor.
        /// - pl: Używaj własnych serwerów przekaźnikowych zamiast domyślnych. Osoby, z którymi wymieniasz pliki, mogą łączyć się przez Twój przekaźnik.
        /// - nl: Gebruik uw eigen relayservers in plaats van de standaardservers. Mensen met wie u bestanden uitwisselt, kunnen via uw relay verbinding maken.
        /// - ru: Используйте свои серверы-ретрансляторы вместо стандартных. Люди, с которыми вы обмениваетесь файлами, могут подключаться через ваш ретранслятор.
        static let modeCustomDescription: String.LocalizationValue = "relay_mode_custom_description"
        /// Default relays
        ///
        /// Key: `relay_mode_default`
        /// Context: Relay settings — option using the default relay servers.
        ///
        /// - en: Default relays
        /// - fr: Relais par défaut
        /// - es: Relés predeterminados
        /// - it: Relay predefiniti
        /// - de: Standard-Relays
        /// - pt: Retransmissores predefinidos
        /// - pl: Domyślne przekaźniki
        /// - nl: Standaardrelays
        /// - ru: Ретрансляторы по умолчанию
        static let modeDefault: String.LocalizationValue = "relay_mode_default"
        /// Transfers connect directly when possible. When a direct connection cannot be made, a relay forwards the encrypted transfer. The relay cannot read your files.
        ///
        /// Key: `relay_mode_default_description`
        /// Context: Relay settings — explains the default relay option.
        ///
        /// - en: Transfers connect directly when possible. When a direct connection cannot be made, a relay forwards the encrypted transfer. The relay cannot read your files.
        /// - fr: Les transferts se connectent directement quand c’est possible. Si aucune connexion directe n’est possible, un relais transmet le transfert chiffré. Le relais ne peut pas lire vos fichiers.
        /// - es: Las transferencias se conectan directamente cuando es posible. Si no se puede establecer una conexión directa, un relé reenvía la transferencia cifrada. El relé no puede leer sus archivos.
        /// - it: I trasferimenti si connettono direttamente quando è possibile. Se non è possibile stabilire una connessione diretta, un relay inoltra il trasferimento cifrato. Il relay non può leggere i suoi file.
        /// - de: Übertragungen verbinden sich nach Möglichkeit direkt. Wenn keine direkte Verbindung möglich ist, leitet ein Relay die verschlüsselte Übertragung weiter. Das Relay kann Ihre Dateien nicht lesen.
        /// - pt: As transferências ligam-se diretamente sempre que possível. Se não for possível uma ligação direta, um retransmissor encaminha a transferência cifrada. O retransmissor não consegue ler os seus ficheiros.
        /// - pl: Transfery łączą się bezpośrednio, gdy to możliwe. Jeśli połączenie bezpośrednie nie jest możliwe, przekaźnik przekazuje zaszyfrowany transfer. Przekaźnik nie może odczytać Twoich plików.
        /// - nl: Overdrachten maken waar mogelijk rechtstreeks verbinding. Als een rechtstreekse verbinding niet mogelijk is, stuurt een relay de versleutelde overdracht door. De relay kan uw bestanden niet lezen.
        /// - ru: Передачи по возможности устанавливают прямое соединение. Если прямое соединение невозможно, ретранслятор пересылает зашифрованную передачу. Ретранслятор не может прочитать ваши файлы.
        static let modeDefaultDescription: String.LocalizationValue = "relay_mode_default_description"
        /// Local network only
        ///
        /// Key: `relay_mode_none`
        /// Context: Relay settings — option disabling relays, limiting transfers to the local network.
        ///
        /// - en: Local network only
        ...
        static let modeNone: String.LocalizationValue = "relay_mode_none"
        /// No relays are used. Devices must be able to reach each other directly.
        ///
        /// Key: `relay_mode_none_description`
        /// Context: Relay settings — explains the local-network-only option.
        ///
        /// - en: No relays are used. Devices must be able to reach each other directly.
        /// - fr: Aucun relais n’est utilisé. Les appareils doivent pouvoir se joindre directement.
        /// - es: No se usa ningún relé. Los dispositivos deben poder comunicarse directamente.
        /// - it: Non viene usato alcun relay. I dispositivi devono potersi raggiungere direttamente.
        /// - de: Es werden keine Relays verwendet. Die Geräte müssen sich direkt erreichen können.
        /// - pt: Não são utilizados retransmissores. Os dispositivos têm de conseguir alcançar-se diretamente.
        /// - pl: Przekaźniki nie są używane. Urządzenia muszą mieć możliwość bezpośredniego połączenia.
        /// - nl: Er worden geen relays gebruikt. Apparaten moeten elkaar rechtstreeks kunnen bereiken.
        /// - ru: Ретрансляторы не используются. Устройства должны иметь возможность связаться напрямую.
        static let modeNoneDescription: String.LocalizationValue = "relay_mode_none_description"
        /// Transfers will only work between devices on the same network. Sending over the internet or mobile data will not connect.
        ///
        /// Key: `relay_none_warning`
        /// Context: Relay settings — warning shown when local-network-only is selected.
        ///
        /// - en: Transfers will only work between devices on the same network. Sending over the internet or mobile data will not connect.
        /// - fr: Les transferts ne fonctionneront qu’entre appareils sur le même réseau. Un envoi par internet ou par données mobiles n’aboutira pas.
        /// - es: Las transferencias solo funcionarán entre dispositivos de la misma red. Los envíos por internet o datos móviles no se conectarán.
        /// - it: I trasferimenti funzioneranno solo tra dispositivi sulla stessa rete. Gli invii tramite internet o rete mobile non si connetteranno.
        /// - de: Übertragungen funktionieren nur zwischen Geräten im selben Netzwerk. Das Senden über das Internet oder mobile Daten kommt nicht zustande.
        /// - pt: As transferências só funcionarão entre dispositivos na mesma rede. O envio pela internet ou por dados móveis não se irá ligar.
        /// - pl: Transfery będą działać tylko między urządzeniami w tej samej sieci. Wysyłanie przez internet lub dane komórkowe nie połączy się.
        /// - nl: Overdrachten werken alleen tussen apparaten op hetzelfde netwerk. Verzenden via internet of mobiele data maakt geen verbinding.
        /// - ru: Передачи будут работать только между устройствами в одной сети. Отправка через интернет или мобильную сеть не установит соединение.
        static let noneWarning: String.LocalizationValue = "relay_none_warning"
        /// Relay changes take effect the next time VniDrop starts. Restarting may interrupt transfers that are in progress.
        ///
        /// Key: `relay_restart_required`
        /// Context: Relay settings — notice that a relay change only applies after restarting the app.
        ///
        /// - en: Relay changes take effect the next time VniDrop starts. Restarting may interrupt transfers that are in progress.
        /// - fr: Les modifications des relais prendront effet au prochain démarrage de VniDrop. Le redémarrage peut interrompre les transferts en cours.
        /// - es: Los cambios en los relés se aplicarán la próxima vez que se inicie VniDrop. Reiniciar puede interrumpir las transferencias en curso.
        /// - it: Le modifiche ai relay avranno effetto al prossimo avvio di VniDrop. Il riavvio può interrompere i trasferimenti in corso.
        /// - de: Änderungen an den Relays werden beim nächsten Start von VniDrop wirksam. Ein Neustart kann laufende Übertragungen unterbrechen.
        /// - pt: As alterações aos retransmissores entram em vigor no próximo arranque do VniDrop. Reiniciar pode interromper transferências em curso.
        /// - pl: Zmiany przekaźników zaczną obowiązywać przy następnym uruchomieniu VniDrop. Ponowne uruchomienie może przerwać trwające transfery.
        /// - nl: Wijzigingen aan relays worden van kracht bij de volgende start van VniDrop. Opnieuw starten kan lopende overdrachten onderbreken.
        /// - ru: Изменения ретрансляторов вступят в силу при следующем запуске VniDrop. Перезапуск может прервать текущие передачи.
        static let restartRequired: String.LocalizationValue = "relay_restart_required"
        /// Relays
        ///
        /// Key: `relay_title`
        /// Context: Settings — Relays section title.
        ///
        /// - en: Relays
        /// - fr: Relais
        /// - es: Relés
        ...
        /// - nl: Relays
        /// - ru: Ретрансляторы
        static let title: String.LocalizationValue = "relay_title"
    }
    enum Send {
        /// Anyone with this transfer
        ///
        /// Key: `send_access_anyone`
        ...
        /// - pt: Qualquer pessoa com esta transferência
        /// - pl: Każdy, kto ma ten transfer
        /// - nl: Iedereen met deze overdracht
        /// - ru: Любой, у кого есть эта передача
        static let accessAnyone: String.LocalizationValue = "send_access_anyone"
        /// No approval is required. Only use this for items you are comfortable sharing.
        ///
        /// Key: `send_access_anyone_description`
        ...
        /// - pt: Não é necessária aprovação. Utilize apenas para itens que não se importe de partilhar.
        /// - pl: Nie jest wymagane zatwierdzenie. Używaj tylko dla elementów, które możesz swobodnie udostępniać.
        /// - nl: Geen goedkeuring vereist. Gebruik dit alleen voor items die u gerust kunt delen.
        /// - ru: Одобрение не требуется. Используйте только для объектов, которыми вы готовы поделиться.
        static let accessAnyoneDescription: String.LocalizationValue = "send_access_anyone_description"
        /// Anyone with the invitation can download until you stop sharing. Do not use this for private or sensitive items.
        ///
        /// Key: `send_access_anyone_warning`
        ...
        /// - pl: Każdy, kto ma zaproszenie, może pobierać, dopóki nie zatrzymasz udostępniania. Nie używaj tego dla prywatnych ani wrażliwych elementów.
        /// - nl: Iedereen met de uitnodiging kan downloaden totdat u stopt met delen. Gebruik dit niet voor privé- of gevoelige items.
        /// - ru: Любой, у кого есть приглашение, может загружать, пока вы не остановите общий доступ. Не используйте это для личных или конфиденциальных объектов.
        static let accessAnyoneWarning: String.LocalizationValue = "send_access_anyone_warning"
        /// Ask before each download
        ///
        /// Key: `send_access_approval`
        ...
        /// - pt: Perguntar antes de cada descarga
        /// - pl: Pytaj przed każdym pobraniem
        /// - nl: Vragen vóór elke download
        /// - ru: Спрашивать перед каждой загрузкой
        static let accessApproval: String.LocalizationValue = "send_access_approval"
        /// You approve or refuse every new receiver.
        ///
        /// Key: `send_access_approval_description`
        ...
        /// - pt: Aprova ou recusa cada novo destinatário.
        /// - pl: Zatwierdzasz lub odrzucasz każdego nowego odbiorcę.
        /// - nl: U keurt elke nieuwe ontvanger goed of weigert deze.
        /// - ru: Вы одобряете или отклоняете каждого нового получателя.
        static let accessApprovalDescription: String.LocalizationValue = "send_access_approval_description"
        /// Who can receive it?
        ///
        /// Key: `send_access_title`
        ...
        /// - pt: Quem a pode receber?
        /// - pl: Kto może to odebrać?
        /// - nl: Wie kan het ontvangen?
        /// - ru: Кто может это получить?
        static let accessTitle: String.LocalizationValue = "send_access_title"
        /// Select files or a folder from this device. You can review the selection before creating the transfer.
        ///
        /// Key: `send_choose_file_body`
        ...
        /// - pt: Selecione ficheiros ou uma pasta deste dispositivo. Poderá rever a seleção antes de criar a transferência.
        /// - pl: Wybierz pliki lub folder z tego urządzenia. Przed utworzeniem transferu możesz przejrzeć wybór.
        /// - nl: Selecteer bestanden of een map op dit apparaat. U kunt de selectie controleren voordat u de overdracht aanmaakt.
        /// - ru: Выберите файлы или папку на этом устройстве. Вы сможете проверить выбор перед созданием передачи.
        static let chooseFileBody: String.LocalizationValue = "send_choose_file_body"
        /// Choose what to share
        ///
        /// Key: `send_choose_file_title`
        ...
        /// - pt: Escolha o que partilhar
        /// - pl: Wybierz, co udostępnić
        /// - nl: Kies wat u wilt delen
        /// - ru: Выберите, чем поделиться
        static let chooseFileTitle: String.LocalizationValue = "send_choose_file_title"
        ...
        /// - pt: Crie uma transferência, decida quem a pode receber e depois convide essas pessoas com um código QR, uma etiqueta NFC ou um ficheiro de convite.
        /// - pl: Utwórz transfer, zdecyduj, kto może go odebrać, a następnie zaproś te osoby za pomocą kodu QR, tagu NFC lub pliku zaproszenia.
        /// - nl: Maak een overdracht aan, bepaal wie deze kan ontvangen en nodig die personen vervolgens uit met een QR-code, NFC-tag of uitnodigingsbestand.
        /// - ru: Создайте передачу, решите, кто может её получить, затем пригласите этих людей с помощью QR-кода, NFC-метки или файла приглашения.
        static let emptyBody: String.LocalizationValue = "send_empty_body"
        /// Nothing shared yet
        ///
        /// Key: `send_empty_title`
        ...
        /// - pt: Ainda não partilhou nada
        /// - pl: Nic jeszcze nie udostępniono
        /// - nl: Nog niets gedeeld
        /// - ru: Пока ничем не поделились
        static let emptyTitle: String.LocalizationValue = "send_empty_title"
        /// Size unavailable
        ///
        /// Key: `send_file_size_unknown`
        ...
        /// - pt: Tamanho indisponível
        /// - pl: Rozmiar niedostępny
        /// - nl: Grootte niet beschikbaar
        /// - ru: Размер недоступен
        static let fileSizeUnknown: String.LocalizationValue = "send_file_size_unknown"
        /// Folder
        ///
        /// Key: `send_folder_label`
        ...
        /// - nl: Map
        /// - ru: Папка
        static let folderLabel: String.LocalizationValue = "send_folder_label"
        /// Create a new transfer
        ///
        /// Key: `send_new_transfer_description`
        ...
        /// - pt: Criar uma nova transferência
        /// - pl: Utwórz nowy transfer
        /// - nl: Een nieuwe overdracht aanmaken
        /// - ru: Создать новую передачу
        static let newTransferDescription: String.LocalizationValue = "send_new_transfer_description"
        /// New transfer
        ///
        /// Key: `send_new_transfer_title`
        ...
        /// - nl: Nieuwe overdracht
        /// - ru: Новая передача
        static let newTransferTitle: String.LocalizationValue = "send_new_transfer_title"
        /// Review transfer
        ///
        /// Key: `send_review_title`
        ...
        /// - nl: Overdracht controleren
        /// - ru: Проверить передачу
        static let reviewTitle: String.LocalizationValue = "send_review_title"
        /// {count} files selected
        ///
        /// Key: `send_selected_files_count`
        ...
        /// - pt: {count} ficheiros selecionados
        /// - pl: Wybrane pliki: {count}
        /// - nl: {count} bestanden geselecteerd
        /// - ru: Выбрано файлов: {count}
        static func selectedFilesCount(count: Int) -> String {
            String(format: String(localized: "send_selected_files_count"), count)
        }
        /// Stop sharing
        ///
        /// Key: `send_stop_sharing`
        ...
        /// - de: Freigabe beenden
        /// - pt: Parar de partilhar
        /// - pl: Zatrzymaj udostępnianie
        /// - nl: Stoppen met delen
        /// - ru: Остановить общий доступ
        static let stopSharing: String.LocalizationValue = "send_stop_sharing"
        /// This stops the transfer and interrupts anyone currently downloading it. It stays in your history as Stopped.
        ///
        /// Key: `send_stop_sharing_description`
        ...
        /// - pt: Isto para a transferência e interrompe quem estiver a descarregá-la. Permanece no seu histórico como Parada.
        /// - pl: To zatrzymuje transfer i przerywa każdego, kto go właśnie pobiera. Pozostaje w historii jako Zatrzymany.
        /// - nl: Hiermee stopt de overdracht en wordt iedereen die deze op dit moment downloadt onderbroken. De overdracht blijft in uw geschiedenis staan als Gestopt.
        /// - ru: Это остановит передачу и прервёт всех, кто сейчас её загружает. Она останется в вашей истории со статусом «Остановлена».
        static let stopSharingDescription: String.LocalizationValue = "send_stop_sharing_description"
        ...
        /// - pt: Transferências que está a partilhar a partir deste dispositivo.
        /// - pl: Transfery udostępniane z tego urządzenia.
        /// - nl: Overdrachten die u vanaf dit apparaat deelt.
        /// - ru: Передачи, которыми вы делитесь с этого устройства.
        static let subtitle: String.LocalizationValue = "send_subtitle"
        /// Send
        ///
        /// Key: `send_title`
        ...
        /// - nl: Versturen
        /// - ru: Отправить
        static let title: String.LocalizationValue = "send_title"
        /// Transfer created.
        ///
        /// Key: `send_transfer_created`
        ...
        /// - pl: Transfer utworzony.
        /// - nl: Overdracht aangemaakt.
        /// - ru: Передача создана.
        static let transferCreated: String.LocalizationValue = "send_transfer_created"
        /// Transfer details
        ///
        /// Key: `send_transfer_details_title`
        ...
        /// - pt: Detalhes da transferência
        /// - pl: Szczegóły transferu
        /// - nl: Overdrachtsdetails
        /// - ru: Сведения о передаче
        static let transferDetailsTitle: String.LocalizationValue = "send_transfer_details_title"
        /// Your transfers
        ///
        /// Key: `send_transfers_title`
        ...
        /// - pt: As suas transferências
        /// - pl: Twoje transfery
        /// - nl: Uw overdrachten
        /// - ru: Ваши передачи
        static let transfersTitle: String.LocalizationValue = "send_transfers_title"
    }
    enum Settings {
        /// Your name, where transfers are saved, appearance, and notifications.
        ///
        /// Key: `settings_subtitle`
        ...
        /// - pt: O seu nome, onde as transferências são guardadas, o aspeto e as notificações.
        /// - pl: Twoja nazwa, miejsce zapisu transferów, wygląd i powiadomienia.
        /// - nl: Uw naam, waar overdrachten worden bewaard, weergave en meldingen.
        /// - ru: Ваше имя, место сохранения передач, оформление и уведомления.
        static let subtitle: String.LocalizationValue = "settings_subtitle"
        /// Settings
        ///
        /// Key: `settings_title`
        ...
        /// - nl: Instellingen
        /// - ru: Настройки
        static let title: String.LocalizationValue = "settings_title"
    }
    enum Snackbar {
        /// Dismiss
        ///
        /// Key: `snackbar_dismiss`
        ...
        /// - nl: Sluiten
        /// - ru: Закрыть
        static let dismiss: String.LocalizationValue = "snackbar_dismiss"
    }
    enum Status {
        /// Available
        ///
        ...
        /// - nl: Beschikbaar
        /// - ru: Доступно
        static let available: String.LocalizationValue = "status_available"
        /// Cancelled
        ///
        ...
        /// - nl: Geannuleerd
        /// - ru: Отменено
        static let cancelled: String.LocalizationValue = "status_cancelled"
        /// Completed
        ///
        ...
        /// - nl: Voltooid
        /// - ru: Завершено
        static let completed: String.LocalizationValue = "status_completed"
        /// Failed
        ///
        /// Key: `status_failed`
        ...
        /// - nl: Mislukt
        /// - ru: Ошибка
        static let failed: String.LocalizationValue = "status_failed"
        /// Preparing
        ///
        ...
        /// - nl: Voorbereiden
        /// - ru: Подготовка
        static let preparing: String.LocalizationValue = "status_preparing"
        /// Receiving
        ///
        ...
        /// - nl: Ontvangen
        /// - ru: Получение
        static let receiving: String.LocalizationValue = "status_receiving"
        /// Stopped
        ///
        /// Key: `status_stopped`
        ...
        /// - nl: Gestopt
        /// - ru: Остановлено
        static let stopped: String.LocalizationValue = "status_stopped"
    }
    enum Storage {
        /// Calculating…
        ///
        /// Key: `storage_calculating`
        ...
        /// - nl: Berekenen…
        /// - ru: Вычисление…
        static let calculating: String.LocalizationValue = "storage_calculating"
        /// Delete all transfers
        ///
        /// Key: `storage_delete_transfers`
        ...
        /// - pt: Eliminar todas as transferências
        /// - pl: Usuń wszystkie transfery
        /// - nl: Alle overdrachten verwijderen
        /// - ru: Удалить все передачи
        static let deleteTransfers: String.LocalizationValue = "storage_delete_transfers"
        /// This clears all sent and received transfer records from your history. Your received files are not deleted. Cached shared content that is no longer needed is reclaimed automatically, which may take a little time. This can’t be undone.
        ///
        /// Key: `storage_delete_transfers_description`
        ...
        static let deleteTransfersDescription: String.LocalizationValue = "storage_delete_transfers_description"
        /// App data
        ///
        /// Key: `storage_app_data`
        ...
        static let appData: String.LocalizationValue = "storage_app_data"
        /// Deleting…
        ///
        /// Key: `storage_deleting`
        ...
        /// - nl: Verwijderen…
        /// - ru: Удаление…
        static let deleting: String.LocalizationValue = "storage_deleting"
        /// Transfer data includes your history and cached content for active shares. Unneeded cache is reclaimed automatically after transfer records are removed, which may take a little time. Received files are tracked for this summary but are never deleted here.
        ///
        /// Key: `storage_footer`
        /// Context: Settings > Storage: footer explaining how storage is managed.
        ///
        /// - en: Transfer data includes your history and cached content for active shares. Unneeded cache is reclaimed automatically after transfer records are removed, which may take a little time. Received files are tracked for this summary but are never deleted here.
        /// - fr: Les données de transfert comprennent votre historique et le contenu mis en cache pour les partages actifs. Le cache inutile est récupéré automatiquement après la suppression des enregistrements, ce qui peut prendre un peu de temps. Les fichiers reçus sont suivis pour ce récapitulatif, mais ne sont jamais supprimés ici.
        /// - es: Los datos de transferencia incluyen su historial y el contenido en caché de los recursos compartidos activos. La caché innecesaria se recupera automáticamente tras eliminar los registros, lo que puede tardar un poco. Los archivos recibidos se registran para este resumen, pero nunca se eliminan aquí.
        ...
        /// - de: Übertragungsdaten umfassen Ihren Verlauf und zwischengespeicherte Inhalte aktiver Freigaben. Nicht mehr benötigter Cache wird nach dem Löschen der Datensätze automatisch bereinigt; dies kann etwas dauern. Empfangene Dateien werden für diese Übersicht erfasst, aber hier niemals gelöscht.
        /// - pt: Os dados de transferência incluem o histórico e o conteúdo em cache das partilhas ativas. A cache desnecessária é recuperada automaticamente após a remoção dos registos, o que pode demorar algum tempo. Os ficheiros recebidos são acompanhados para este resumo, mas nunca são eliminados aqui.
        /// - pl: Dane transferu obejmują historię oraz zawartość w pamięci podręcznej dla aktywnych udostępnień. Niepotrzebna pamięć podręczna jest odzyskiwana automatycznie po usunięciu rekordów, co może chwilę potrwać. Odebrane pliki są śledzone na potrzeby tego podsumowania, ale nigdy nie są tu usuwane.
        /// - nl: Overdrachtsgegevens omvatten uw geschiedenis en inhoud in de cache voor actieve shares. Onnodige cache wordt automatisch opgeruimd nadat overdrachtsrecords zijn verwijderd; dit kan enige tijd duren. Ontvangen bestanden worden voor dit overzicht bijgehouden, maar hier nooit verwijderd.
        /// - ru: Данные передачи включают историю и кэшированное содержимое активных раздач. Ненужный кэш освобождается автоматически после удаления записей; это может занять некоторое время. Полученные файлы учитываются в этой сводке, но никогда не удаляются здесь.
        static let footer: String.LocalizationValue = "storage_footer"
        /// Received files
        ///
        /// Key: `storage_received_files`
        ...
        /// - pt: Ficheiros recebidos
        /// - pl: Odebrane pliki
        /// - nl: Ontvangen bestanden
        /// - ru: Полученные файлы
        static let receivedFiles: String.LocalizationValue = "storage_received_files"
        /// Temporary files
        ///
        /// Key: `storage_temporary`
        ...
        /// - pt: Ficheiros temporários
        /// - pl: Pliki tymczasowe
        /// - nl: Tijdelijke bestanden
        /// - ru: Временные файлы
        static let temporary: String.LocalizationValue = "storage_temporary"
        /// Storage
        ///
        /// Key: `storage_title`
        ...
        /// - nl: Opslag
        /// - ru: Хранилище
        static let title: String.LocalizationValue = "storage_title"
        /// Total
        ///
        /// Key: `storage_total`
        ...
        /// - nl: Totaal
        /// - ru: Всего
        static let total: String.LocalizationValue = "storage_total"
        /// Transfer data
        ///
        /// Key: `storage_transfer_data`
        ...
        /// - pt: Dados de transferência
        /// - pl: Dane transferu
        /// - nl: Overdrachtsgegevens
        /// - ru: Данные передачи
        static let transferData: String.LocalizationValue = "storage_transfer_data"
        /// All transfers deleted
        ///
        /// Key: `storage_transfers_deleted`
        ...
        /// - pt: Todas as transferências eliminadas
        /// - pl: Usunięto wszystkie transfery
        /// - nl: Alle overdrachten verwijderd
        /// - ru: Все передачи удалены
        static let transfersDeleted: String.LocalizationValue = "storage_transfers_deleted"
    }
    enum Transfer {
        /// See important updates for this transfer
        ///
        /// Key: `transfer_activity_description`
        ...
        /// - pt: Ver as atualizações importantes desta transferência
        /// - pl: Zobacz ważne aktualizacje tego transferu
        /// - nl: Bekijk belangrijke updates voor deze overdracht
        /// - ru: Просматривайте важные обновления этой передачи
        static let activityDescription: String.LocalizationValue = "transfer_activity_description"
        /// Activity
        ///
        /// Key: `transfer_activity_title`
        ...
        /// - nl: Activiteit
        /// - ru: Активность
        static let activityTitle: String.LocalizationValue = "transfer_activity_title"
        /// “{transferName}” will stop being shared and its transfer history will be removed from this device.
        ///
        /// Key: `transfer_delete_description`
        ...
        static func deleteDescription(transferName: String) -> String {
            String(format: String(localized: "transfer_delete_description"), transferName)
        }
        /// Delete transfer?
        ///
        /// Key: `transfer_delete_title`
        ...
        /// - de: Übertragung löschen?
        /// - pt: Eliminar a transferência?
        /// - pl: Usunąć transfer?
        /// - nl: Overdracht verwijderen?
        /// - ru: Удалить передачу?
        static let deleteTitle: String.LocalizationValue = "transfer_delete_title"
        /// Transfer deleted.
        ///
        /// Key: `transfer_deleted`
        ...
        /// - pt: Transferência eliminada.
        /// - pl: Transfer usunięty.
        /// - nl: Overdracht verwijderd.
        /// - ru: Передача удалена.
        static let deleted: String.LocalizationValue = "transfer_deleted"
        /// Deleting…
        ///
        /// Key: `transfer_deleting`
        ...
        /// - nl: Verwijderen…
        /// - ru: Удаление…
        static let deleting: String.LocalizationValue = "transfer_deleting"
        /// Transfer details
        ///
        /// Key: `transfer_details_title`
        ...
        /// - nl: Overdrachtsdetails
        /// - ru: Сведения о передаче
        static let detailsTitle: String.LocalizationValue = "transfer_details_title"
        /// Receiver access approved
        ///
        /// Key: `transfer_event_approved`
        ...
        /// - pl: Zatwierdzono dostęp odbiorcy
        /// - nl: Toegang ontvanger goedgekeurd
        /// - ru: Доступ получателя одобрен
        static let eventApproved: String.LocalizationValue = "transfer_event_approved"
        /// A receiver completed the transfer
        ///
        /// Key: `transfer_event_completed`
        ...
        /// - pt: Um destinatário concluiu a transferência
        /// - pl: Odbiorca ukończył transfer
        /// - nl: Een ontvanger heeft de overdracht voltooid
        /// - ru: Получатель завершил передачу
        static let eventCompleted: String.LocalizationValue = "transfer_event_completed"
        /// Connecting to sender
        ///
        /// Key: `transfer_event_connecting`
        ...
        /// - pt: A ligar ao remetente
        /// - pl: Łączenie z nadawcą
        /// - nl: Verbinden met afzender
        /// - ru: Подключение к отправителю
        static let eventConnecting: String.LocalizationValue = "transfer_event_connecting"
        /// Downloading
        ///
        /// Key: `transfer_event_downloading`
        ...
        /// - nl: Downloaden
        /// - ru: Загрузка
        static let eventDownloading: String.LocalizationValue = "transfer_event_downloading"
        /// The transfer encountered a problem
        ///
        /// Key: `transfer_event_failed`
        ...
        /// - pt: A transferência teve um problema
        /// - pl: Podczas transferu wystąpił problem
        /// - nl: Er is een probleem opgetreden bij de overdracht
        /// - ru: При передаче возникла проблема
        static let eventFailed: String.LocalizationValue = "transfer_event_failed"
        /// Preparing your transfer
        ///
        /// Key: `transfer_event_preparing`
        ...
        /// - pt: A preparar a sua transferência
        /// - pl: Przygotowywanie transferu
        /// - nl: Uw overdracht voorbereiden
        /// - ru: Подготовка вашей передачи
        static let eventPreparing: String.LocalizationValue = "transfer_event_preparing"
        /// Ready to share
        ///
        /// Key: `transfer_event_ready`
        ...
        /// - nl: Klaar om te delen
        /// - ru: Готово к отправке
        static let eventReady: String.LocalizationValue = "transfer_event_ready"
        /// Receiver access refused
        ///
        /// Key: `transfer_event_refused`
        ...
        /// - pt: Acesso do destinatário recusado
        /// - pl: Odrzucono dostęp odbiorcy
        /// - nl: Toegang ontvanger geweigerd
        /// - ru: Доступ получателя отклонён
        static let eventRefused: String.LocalizationValue = "transfer_event_refused"
        /// A receiver requested access
        ///
        /// Key: `transfer_event_requested`
        ...
        /// - pt: Um destinatário pediu acesso
        /// - pl: Odbiorca poprosił o dostęp
        /// - nl: Een ontvanger heeft toegang aangevraagd
        /// - ru: Получатель запросил доступ
        static let eventRequested: String.LocalizationValue = "transfer_event_requested"
        /// Saving
        ///
        /// Key: `transfer_event_saving`
        ...
        /// - nl: Bewaren
        /// - ru: Сохранение
        static let eventSaving: String.LocalizationValue = "transfer_event_saving"
        /// Sharing stopped
        ///
        /// Key: `transfer_event_stopped`
        ...
        /// - de: Freigabe beendet
        /// - pt: Partilha parada
        /// - pl: Zatrzymano udostępnianie
        /// - nl: Delen gestopt
        /// - ru: Раздача остановлена
        static let eventStopped: String.LocalizationValue = "transfer_event_stopped"
        /// Transfer updated
        ///
        /// Key: `transfer_event_updated`
        ...
        /// - pt: Transferência atualizada
        /// - pl: Transfer zaktualizowany
        /// - nl: Overdracht bijgewerkt
        /// - ru: Передача обновлена
        static let eventUpdated: String.LocalizationValue = "transfer_event_updated"
        /// {count} files
        ///
        /// Key: `transfer_file_count`
        ...
        /// - nl: {count} bestanden
        /// - ru: {count} файла
        static func fileCount(count: Int) -> String {
            String(format: String(localized: "transfer_file_count"), count)
        }
        /// Invitation saved.
        ///
        /// Key: `transfer_invitation_saved`
        ...
        /// - pt: Convite guardado.
        /// - pl: Zaproszenie zapisane.
        /// - nl: Uitnodiging bewaard.
        /// - ru: Приглашение сохранено.
        static let invitationSaved: String.LocalizationValue = "transfer_invitation_saved"
        /// Nearby device
        ///
        /// Key: `transfer_nearby_device`
        ...
        /// - pt: Dispositivo próximo
        /// - pl: Urządzenie w pobliżu
        /// - nl: Apparaat in de buurt
        /// - ru: Устройство поблизости
        static let nearbyDevice: String.LocalizationValue = "transfer_nearby_device"
        /// NFC tag writing is not available on this device.
        ///
        /// Key: `transfer_nfc_unavailable`
        ...
        /// - pt: A escrita de etiquetas NFC não está disponível neste dispositivo.
        /// - pl: Zapis tagów NFC nie jest dostępny na tym urządzeniu.
        /// - nl: Het schrijven van NFC-tags is niet beschikbaar op dit apparaat.
        /// - ru: Запись NFC-меток недоступна на этом устройстве.
        static let nfcUnavailable: String.LocalizationValue = "transfer_nfc_unavailable"
        /// Hold your device near a writable NFC tag.
        ///
        /// Key: `transfer_nfc_waiting`
        ...
        /// - pt: Aproxime o seu dispositivo de uma etiqueta NFC gravável.
        /// - pl: Zbliż urządzenie do zapisywalnego tagu NFC.
        /// - nl: Houd uw apparaat bij een beschrijfbare NFC-tag.
        /// - ru: Поднесите устройство к записываемой NFC-метке.
        static let nfcWaiting: String.LocalizationValue = "transfer_nfc_waiting"
        /// Invitation written to the NFC tag.
        ///
        /// Key: `transfer_nfc_written`
        ...
        /// - pt: Convite escrito na etiqueta NFC.
        /// - pl: Zaproszenie zapisane na tagu NFC.
        /// - nl: Uitnodiging naar de NFC-tag geschreven.
        /// - ru: Приглашение записано на NFC-метку.
        static let nfcWritten: String.LocalizationValue = "transfer_nfc_written"
        /// There is no activity to show yet.
        ///
        /// Key: `transfer_no_activity`
        ...
        /// - pt: Ainda não há atividade para mostrar.
        /// - pl: Nie ma jeszcze aktywności do wyświetlenia.
        /// - nl: Er is nog geen activiteit om weer te geven.
        /// - ru: Пока нет активности для отображения.
        static let noActivity: String.LocalizationValue = "transfer_no_activity"
        /// Nobody has requested this transfer yet.
        ///
        /// Key: `transfer_no_receivers`
        ...
        /// - pt: Ainda ninguém pediu esta transferência.
        /// - pl: Nikt jeszcze nie poprosił o ten transfer.
        /// - nl: Nog niemand heeft deze overdracht aangevraagd.
        /// - ru: Никто ещё не запросил эту передачу.
        static let noReceivers: String.LocalizationValue = "transfer_no_receivers"
        /// Approved — waiting for completion
        ///
        /// Key: `transfer_receiver_accepted`
        ...
        /// - pt: Aprovado — a aguardar conclusão
        /// - pl: Zatwierdzono — oczekiwanie na ukończenie
        /// - nl: Goedgekeurd — wachten op voltooiing
        /// - ru: Одобрено — ожидание завершения
        static let receiverAccepted: String.LocalizationValue = "transfer_receiver_accepted"
        /// Received successfully
        ///
        /// Key: `transfer_receiver_completed`
        ...
        /// - pt: Recebido com sucesso
        /// - pl: Odebrano pomyślnie
        /// - nl: Succesvol ontvangen
        /// - ru: Успешно получено
        static let receiverCompleted: String.LocalizationValue = "transfer_receiver_completed"
        /// Request expired
        ///
        /// Key: `transfer_receiver_expired`
        ...
        /// - nl: Verzoek verlopen
        /// - ru: Запрос истёк
        static let receiverExpired: String.LocalizationValue = "transfer_receiver_expired"
        /// Request refused
        ///
        /// Key: `transfer_receiver_refused`
        ...
        /// - ru: Запрос отклонён
        static let receiverRefused: String.LocalizationValue = "transfer_receiver_refused"
        /// Waiting for your approval
        ///
        /// Key: `transfer_receiver_requested`
        ...
        /// - pt: A aguardar a sua aprovação
        /// - pl: Oczekiwanie na Twoje zatwierdzenie
        /// - nl: Wachten op uw goedkeuring
        /// - ru: Ожидание вашего одобрения
        static let receiverRequested: String.LocalizationValue = "transfer_receiver_requested"
        /// Status unavailable
        ///
        /// Key: `transfer_receiver_unknown`
        ...
        static let receiverUnknown: String.LocalizationValue = "transfer_receiver_unknown"
        /// {count} completed
        ///
        /// Key: `transfer_receivers_completed_count`
        ...
        /// - nl: {count} voltooid
        /// - ru: Завершено: {count}
        static func receiversCompletedCount(count: Int) -> String {
            String(format: String(localized: "transfer_receivers_completed_count"), count)
        }
        /// Requests, approvals, and completed deliveries
        ///
        /// Key: `transfer_receivers_description`
        ...
        /// - pt: Pedidos, aprovações e entregas concluídas
        /// - pl: Prośby, zatwierdzenia i ukończone dostawy
        /// - nl: Verzoeken, goedkeuringen en voltooide leveringen
        /// - ru: Запросы, одобрения и завершённые доставки
        static let receiversDescription: String.LocalizationValue = "transfer_receivers_description"
        /// {count} waiting
        ///
        /// Key: `transfer_receivers_pending`
        ...
        /// - ru: Ожидают: {count}
        static func receiversPending(count: Int) -> String {
            String(format: String(localized: "transfer_receivers_pending"), count)
        }
        /// Receivers
        ///
        /// Key: `transfer_receivers_title`
        ...
        /// - nl: Ontvangers
        /// - ru: Получатели
        static let receiversTitle: String.LocalizationValue = "transfer_receivers_title"
        /// Scan with VniDrop to receive this transfer
        ///
        /// Key: `transfer_scan_qr`
        ...
        /// - pt: Leia com o VniDrop para receber esta transferência
        /// - pl: Zeskanuj za pomocą VniDrop, aby odebrać ten transfer
        /// - nl: Scan met VniDrop om deze overdracht te ontvangen
        /// - ru: Отсканируйте с помощью VniDrop, чтобы получить эту передачу
        static let scanQr: String.LocalizationValue = "transfer_scan_qr"
        /// QR code, invitation file, and nearby options
        ///
        /// Key: `transfer_share_description`
        ...
        /// - pt: Código QR, ficheiro de convite e opções por perto
        /// - pl: Kod QR, plik zaproszenia i opcje w pobliżu
        /// - nl: QR-code, uitnodigingsbestand en opties in de buurt
        /// - ru: QR-код, файл приглашения и варианты поблизости
        static let shareDescription: String.LocalizationValue = "transfer_share_description"
        /// Share
        ///
        /// Key: `transfer_share_title`
        ...
        /// - nl: Delen
        /// - ru: Поделиться
        static let shareTitle: String.LocalizationValue = "transfer_share_title"
    }
    enum Value {
        /// Not available
        ///
        /// Key: `value_unavailable`
        ...
        /// - nl: Niet beschikbaar
        /// - ru: Недоступно
        static let unavailable: String.LocalizationValue = "value_unavailable"
    }
    enum Version {
        /// App version
        ///
        ...
        static let title: String.LocalizationValue = "version_title"
    }
}
